...
#        plot_rpn_expression_tree("x1 8 / x1 sin 1.0000132758892615 x0 sin * * -".split(), save = save, title = r"Example", tolatex = True, to_pdf = True, filename = "Example.pdf")
        plot_pn_expression_tree("^ - / 1 - 1 exp ~ f x26 2".split(), save = save)
#        plot_rpn_expression_tree("1 1 f ~ exp - / x26 - 2 ^".split(), save = save, tolatex = True, to_pdf = True, filename = "Example.pdf", include_expression_in_title = False)
