...
#        print(complete_tree("".split(), "prefix"))
        ...
        complete_rpn_expr = complete_tree("x6 0.006210 - x17 9741 + + 1 x13 / + 77888 x22 * 20200101.000000 x6 + cos ^ - 8.851731000000001 0.00621 x6 + / 4.372938 x7 + x20 279.200012 + - ^ - x25 3.4288275429960554e+302 - -100.000000 x1 + -100 ^ x5 + 0.051731 x18 + 0.006210 x20 / 2 + - ^ / + x22 8.800000 * 38.000000 x20 ^ + x8 x0 + -2.640000 x2 + - ^ 405.7971014492754 x15 ^ x20 + + x17 38.000000 x8 + x11 * / 92.45173100000001 x23 - ^ + x19 0.00621 + 39.3125 x21 - * -818.627062 + -54 x22 * x21 acos -18327.436844999997 + + + * +".split(), "postfix")
