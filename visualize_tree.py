...
def test_visualize():
    ...
    if save:
        ...
        if pn_to_rpn:
            ...
            infix_expr = '910.397368074356*s**2 + (0.314841993559647*(acos(s)*sech(s) + acos(tanh(s)) + 3.02740979101125)*(-8.05899612997608*s + (2*s + 0.785851445748185)*(-0.0325671912919011*s**2*(acos(s) + sech(4*acos(s))) + (asin(s) + 8.13633607358685)*(s*(-s + (0.899811376058683*s + 0.899811376058683*sin(s) - 0.829766398269697)*tanh(sin(4*s)) + cos(14.6035329879037*sqrt(s)) - 3.95618772941399) + s + 2.3559099869491*acos(sqrt(s)) - asin(asin(acos(sin(s + 1.03104122700201)))) + 7.29280717367267) - 1.39359502558743*acos(-cos(2.56818874641457*s + 6)) + asin(s) - 84.7985117619608*sech(s)) - (8.04810486353913*s - 14.2536676544543)*(-s*acos(1 - s) - 7.291416548253*s + (1 - sin(9.48961073423258*s))*(sqrt(s) + 0.52635857279476) + 7.39986536855855) + 9.26843360498466*tanh(4*s - 1) - acos(sech(cos(acos(s) + 0.76139129151653))) - 63.1384792300689*sech(9.51613132844858*s + 0.532696093328641) - 44.9054947614368) + 0.713957096037977*sech(sin(cos(7.99801234306377*s + 7.99824697451744))))*(asin(sech(tanh(acos(s) - 0.988620265570046))) + 4)'.replace("**","^")
            ...
            if expression_type_to_plot == "prefix":
                ...
                complete_rpn_expr = "910.397368074356 x0 x0 * * 0.314841993559647 x0 acos x0 sech * x0 tanh acos + 3.02740979101125 + * -8.05899612997608 x0 * 2 x0 * 0.785851445748185 + -0.0325671912919011 x0 x0 * * x0 acos 4 x0 acos * sech + * x0 asin 8.13633607358685 + x0 x0 ~ 0.899811376058683 x0 * 0.899811376058683 x0 sin * + 0.829766398269697 - 4 x0 * sin tanh * + 14.6035329879037 x0 sqrt * cos + 3.95618772941399 - * x0 + 2.3559099869491 x0 sqrt acos * + x0 1.03104122700201 + sin acos asin asin - 7.29280717367267 + * + 1.39359502558743 2.56818874641457 x0 * 6 + cos ~ acos * - x0 asin + 84.7985117619608 x0 sech * - * + 8.04810486353913 x0 * 14.2536676544543 - x0 ~ 1 x0 - acos * 7.291416548253 x0 * - 1 9.48961073423258 x0 * sin - x0 sqrt 0.52635857279476 + * + 7.39986536855855 + * - 9.26843360498466 4 x0 * 1 - tanh * + x0 acos 0.76139129151653 + cos sech acos - 63.1384792300689 9.51613132844858 x0 * 0.532696093328641 + sech * - 44.9054947614368 - * 0.713957096037977 7.99801234306377 x0 * 7.99824697451744 + cos sin sech * + x0 acos 0.988620265570046 - tanh sech asin 4 + * +"
