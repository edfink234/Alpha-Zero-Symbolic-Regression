    ...
    if save:
        ...
        if pn_to_rpn:
            ...
            if expression_type_to_plot == "prefix":
                ...
                complete_rpn_expr = 'x2 sin x2 + -0.0023387948425080507 * x0 tanh x0 0.0019827211023140047 * * x0 8.255878510054912e-06 * 0.5098147996402167 + + + 0.5425284693676308 x3 0.05624689104254691 * + x0 sech 0.35131877940503314 x2 * + * -3.836315705818223 x2 tanh -0.1681008731569781 x3 + + + + * sech x2 17.078343439402524 + ~ x2 -2.5411489085468753 + x3 -0.6653884403879969 * * * x2 -31.756159586996276 + x3 sech * tanh + 0.4624658502508486 x3 sech -0.009620252153683246 * + x2 -10.107719855486913 + -1.9668630551054243 x3 * * 7.676814935247006e-06 * + * 1.0000756780092264 x0 * -0.04202368679684226 * x3 tanh sin * x0 ~ 1.842014297052797 * sin * 1.6122150243780295 x2 -2.540001963863744 + * ~ 0.02034514652320025 x3 3.268960822723918 * + x2 x3 * 0.1901464130284396 * + * + + +'
