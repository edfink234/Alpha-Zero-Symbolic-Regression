...
def test_visualize():
    ...
    if save:
        ...
        if pn_to_rpn:
            ...
            infix_expr = '44.0559538818485*sqrt(s)*sqrt(acos(s)) + (9.66283442061196 - s)*(35.8230932186291*s*(0.0643085467043386*s - 0.0719465827638698)*sin(14.9226649156947*s) + (2626.74449821454*sqrt(s) + 1143.77982223734*s*(-1.03766535128574*s**2 + 2.59188754904655*s - 3.37690843071011) - 303.761598515569*sech(8.00100734295832*s) - 659.843183884782)*tanh(s) - 1.08633065674317*tanh(sin(16*s)) - 35.8230932186291*tanh(acos(tanh(22.0864706886495*s))) + 33.1631182658531) + 127.340360527131*tanh(36.5496273885755*s) - 51.9856445151883*tanh(cos(8.691366312679*s - 1.49136657646376)) + acos(sin(2*s)) + 112.112407769933*sqrt(asin(s)) + 127.340360527131*asin(s)'.replace("**","^")
            ...
            if expression_type_to_plot == "prefix":
                ...
                complete_rpn_expr = '44.0559538818485 x0 sqrt * x0 acos sqrt * 9.66283442061196 x0 - 35.8230932186291 x0 * 0.0643085467043386 x0 * 0.0719465827638698 - * 14.9226649156947 x0 * sin * 2626.74449821454 x0 sqrt * 1143.77982223734 x0 * -1.03766535128574 x0 2 ^ * 2.59188754904655 x0 * + 3.37690843071011 - * + 303.761598515569 8.00100734295832 x0 * sech * - 659.843183884782 - x0 tanh * + 1.08633065674317 16 x0 * sin tanh * - 35.8230932186291 22.0864706886495 x0 * tanh acos tanh * - 33.1631182658531 + * + 127.340360527131 36.5496273885755 x0 * tanh * + 51.9856445151883 8.691366312679 x0 * 1.49136657646376 - cos tanh * - 2 x0 * sin acos + 112.112407769933 x0 asin sqrt * + 127.340360527131 x0 asin * +'
