    ...
    if save:
        ...
        if pn_to_rpn:
            ...
            if expression_type_to_plot == "prefix":
                ...
                complete_rpn_expr = "0.010000 x0 + x1 sech + x0 sech 11.13 + ^ 2.714063472005533e-13 * x0 6.283190 ^ 1e-08 * 0.01 + 0.7417992273364366 + + 0.9998848754538172 x0 4.029999999999999 ^ ^ x1 ~ sin 0.9972802451715356 * * 0.8912763105205549 x0 cos asin cos * * - 9.079985933781724e-05 0.27580222883407973 x0 10.000000 + ^ x1 1 - * * 4.692820413780688e-06 x1 0.010000 - x1 x1 + + * -0.07517032657318981 + + x0 0.010000 x0 + 1 + / x0 sin 0.010000 x0 + + x1 sin 10.000000 x0 / + * ^ 0.06683971220255538 + + -"
                if completeTree:
