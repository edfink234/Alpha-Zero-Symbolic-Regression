    ...
    if save:
        ...
        if pn_to_rpn:
            ...
            if expression_type_to_plot == "prefix":
                ...
                complete_rpn_expr = "-2.446317 x0 1.026171 x0 sqrt cos ^ ^ * -26.267023 4.207354924039483 168.000000 x0 + sqrt * cos * - x0 25.114484 1.014280 x0 ^ cos tanh * + + -8.094348 -3.652141 x0 0.6931471805599453 ^ - cos * - -106.639258 x0 + 118.95633426995997 x0 0.995137 / - / + 0.985554 x0 2.685784865116654 / * sin 5.048220 * - 1.502449 x0 0.997721 ^ ^ log cos + 2.081938 2.962750 x0 - 0.2658022288340797 * sin * exp + x0 -0.45018598229727835 * sin -2.744077 * + -1.635574 x0 -1.6880058284590451 / cos * - x0 0.696976831813758 x0 * cos + + 0.031400 4 x0 0.7615941559557649 - * sin / - 4.063501 1.052177 x0 0.992804 ^ ^ + sqrt sin + 1.027196 ~ 2 x0 0.8414709848078965 ^ * * cos + 50.065514 0.03661899347368653 11.175638 x0 54.598150033144236 - + / * +"
                if completeTree:
