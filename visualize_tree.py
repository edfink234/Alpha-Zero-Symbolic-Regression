    ...
    if save:
        ...
        if pn_to_rpn:
            ...
            if expression_type_to_plot == "prefix":
                ...
                complete_rpn_expr = '-0.00010340374619291778 x2 ~ x2 sin * * -0.7804756420720398 + 0.999609801635245 -1.697340338394691e-10 x0 + sin * ~ * -0.16505894048534406 1.0000001797097067 x3 ~ * x3 1.9443452612560486 + 1.0000001960145004 x3 * + + * 0.0008312567672379576 x2 -2.673229881336812 + -2.6688162237660573 + * 4.356193486569983 + + * 2.5707958096686965 0.7853980769120263 x2 x3 * * * 2.292846012646777e-07 x0 + x0 ~ + 2.0306076788641345 x2 x3 * + + + 3.142855428784867 x1 ~ -0.9999994990155153 + + 7.4481316590808335 + + sin *'
