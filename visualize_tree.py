...
def test_visualize():
    ...
    if save:
        ...
        if pn_to_rpn:
            ...
            infix_expr = '(16.9166542640983*s + 4.38154042026066)*(4*s*(3.0392759607765*s*(s + 0.695906243498109)*(0.0855206544759836*s*tanh(sin(4*s)) - 0.396460556166009*sqrt(1 - s**2) + 5.40495766643892) - 18.9535256959506*s*asin(asin(tanh(s))) - 6.54789810415906*sqrt(sqrt(s) + asin(s)) + 2.75749963270677) + (4*s - 3.77375522508355)*(-0.992922506141499*sqrt(s) + 0.107736064849549*sin(9.68863196105496*s) - 1.10136955802896) - tanh(asin(sech(13.4039492609529*s)))) + 0.0421706330441903*sin(50.9389412016731*s) + 0.0725657196208038*sin(58.3334014933741*s) + 0.0149375385653387*sin(s*(acos(s) - 44.2017995927063)) + 11.8694797041842*sin(cos(8.41483656419485*s + 3.23425263485772)) + 0.0183016368487537*cos(36.8184713771202*s) + 0.03233668835194*cos(66.7332200361866*s) - 38.1956498016522*asin(cos(acos(s) - 0.743770532914356)) + 25.2016463209627'.replace("**","^")
            ...
            if expression_type_to_plot == "prefix":
                ...
                complete_rpn_expr = 'x0 cos 0.96402913805394 - sech asin sqrt 3.14513971405279 + x0 10.8981563281581 + 2 x0 * 3.34592640201652 2.34233982573766 x0 * - * 0.12925440287365 0.556464790938022 x0 * - 9.68908970669284 x0 * sin 0.677821820730414 - * - -0.240315432582163 x0 0.92128303565694 + sin acos * 12.1279362659261 x0 * sech - x0 asin * - * x0 sqrt 0.118754696358058 + tanh * x0 ~ 1.59032096158348 x0 asin * - 0.0920588500849169 - x0 1 - acos * + 2.19854041277261 x0 * 8.98351577236256 x0 asin * + 3.271871691709 + x0 x0 acos - sech asin * - 4.05207595917072 x0 * 2.87339945312129 - sin acos + *'
