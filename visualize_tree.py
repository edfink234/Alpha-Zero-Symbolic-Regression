...
#                plot_rpn_expression_tree("q Ef * m omega_0 2 ^ omega 2 ^ - *  /".split(), block=False, save = save)
                plot_pn_expression_tree("+ * x * ^ tanh / x y sin x + * ln tanh / x y * cos x 1 * / * * sech / x y sech / x y / y * y y tanh / x y sin x ^ tanh / x y sin x".split(), block=True, save = save)
#            plot_pn_expression_tree("1 x cos 1 * + ~".split(), block=True, save = save)
#                plot_rpn_expression_tree("x cos x cos 1 * * x sin ~ 1 * x sin * + ~ x cos x sin * x cos x sin * * /".split(), block=True, save = save)
