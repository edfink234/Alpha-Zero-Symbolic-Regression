    ...
    if save:
        ...
        if pn_to_rpn:
            ...
            if expression_type_to_plot == "prefix":
                ...
                complete_rpn_expr = "x0 x0 0.553383132922292 + sin acos sqrt 1.18790932543968 x0 asin 2.02355519788142 + cos asin * - * x0 2.46760160818239 x0 * 30.4043813110764 x0 * sin - 1.40892879225438 - * x0 0.426797989064436 - sin * 128.22894957808 x0 * 14.8125843331092 x0 tanh * + 0.591806468389593 + cos * x0 acos * - 6.36973788742964 x0 * x0 x0 acos + sin * + 0.0249395461181365 x0 * 106.981110859755 x0 2 ^ * 0.342141682281778 - sin * + 1.56193447763868 x0 * - 1.25182684813625 1.82425731438467 x0 acos * - x0 0.010518114667387 + * -4 x0 2 ^ * 0.886812526567498 - * x0 2 ^ 0.983481325354971 - * 49.5981878955111 x0 acos * cos * x0 acos * - x0 0.316756057235402 ^ 5.36024294716339 x0 sqrt * - x0 sqrt ~ x0 tanh + 0.7084991686998 + * + x0 1.26234284461757 - 0.203187506120896 128 x0 * cos 0.357307482108696 - sech * 3.79453579450201 - * - x0 0.298622949070965 + 129.011124984096 x0 * 44.3453280542052 x0 sin * - cos sech sech 0.899450372726447 + * x0 acos * + 0.877298318349341 x0 2 ^ * x0 acos 1.31882066092311 - tanh + 0.847175637076692 x0 * sin tanh x0 asin - 0.00529502130283832 - * 19.986371288393 x0 * x0 12 + * sin * + 0.290711043523477 x0 sqrt * 0.290711043523477 x0 * + 0.759369751662782 x0 tanh * - 0.00268230525359189 + 239.144780254996 x0 * 238.499723701356 - cos * + 2.06630417477921 1 5.4020867549067 x0 * sin 2 ^ - sqrt * 2.06630417477921 0.482507960693283 x0 * 0.0541693735485751 + * 16.8810135673934 4.70013909258339 x0 * sin * 5.54311897981944 9.52745260649217 x0 * sin * - 13.5798739096497 13.8285680347055 x0 * sin * - 33 x0 * cos + * + 0.282938378413181 26.7226613223422 x0 acos * sin * - 0.645352890200415 92.4231072442528 x0 cos * cos * - 0.424482377008902 3.14044228605039 x0 * cos * cos * + 2 x0 sin sqrt * - 0.0525689617761999 88.6658617680321 13.633163177028 x0 * - x0 x0 sin - 2.02296125405477 - * x0 asin * sin * - x0 x0 cos - sin - 0.00887383216262311 102.511268806185 x0 tanh * 0.438031100154257 - sin * x0 acos * + x0 cos x0 acos - sech acos tanh sqrt sin + 0.0781956966275807 171.467751390607 x0 * 124.024677319387 x0 acos * - 122.15343913514 + cos * - 0.0444768066277004 22.4507800456351 53.9444914557017 x0 acos * - x0 2.36812216281262 + * sin tanh tanh * - 1.8809991176 x0 acos 0.710852793070229 + sin acos asin 0.316756057235402 ^ tanh * - x0 sqrt acos + 2.02603029922744 14.740730229199 x0 * cos sin sech asin * - 0.871343025656339 -"
