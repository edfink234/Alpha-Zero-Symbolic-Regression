    ...
    if save:
        ...
        if pn_to_rpn:
            ...
            if expression_type_to_plot == "prefix":
                ...
                complete_rpn_expr = '8.936397390317548 60.003486966262265 x0 * 23.864453239559598 31.175521825964026 x0 * tanh 9.937114815410464 x0 sqrt * x0 15.523967797607401 * + ~ + + 7.982772371612305 x0 x0 + tanh * + * -5.227773664306295 x0 acos * x0 -0.6858804825107394 + 70.90229246959326 -11.81564388447175 x0 * sin + * * + -395.52970435452073 + * x0 x0 + cos 4.074361247256768 x0 * 802.4942510380514 * * - 1.4408306715462371 x0 43.582187618788474 2.00880588414951 x0 * - * sin * - 51.99317086251765 -0.2685428271086607 -10.914887365170808 x0 * - cos sech * + 17.436271685454695 x0 asin 61.783875970318626 * * - 70.04180638857441 0.5966257276544789 4 x0 * - sech arcsin * - 0.5535327415769157 -168.66151143439296 x0 sech * 4 x0 * cos 1.3801146798636523 * - 1.0011959515562738 * sin acos * - x0 4 x0 tanh + + 4 x0 ~ 9.37284768211159 - * * cos asin x0 cos -14.162323338259014 x0 tanh 1.963934884513592 x0 -3.494407086632349 - * * x0 -6.394675227521159 x0 -3.281720990452876 * -1.4281943695885402 - sech - * + * * * - -0.3683942693669485 x0 16 * cos 3.918690544393869 * 6.089087275726692 x0 0.8491898178350344 + * + sin sech acos asin * +'
