...
def test_visualize():
    ...
    if save:
        ...
        if pn_to_rpn:
            ...
            infix_expr = '(16.3228496246705*s + 30.4679030605049)*(4*s*(4.56698103776342*s*(s - 0.0175132451934974)*(0.575084618586708*s*tanh(sin(4*s)) - 0.48481268218809*sqrt(1 - s**2) + 6.35852172544418) - 19.6325790772985*s*asin(asin(tanh(s))) - 7.75161408458609*sqrt(sqrt(s) + asin(s)) + 6.48068144306375) + (4*s - 1.57709855167273)*(0.365872214556238*sqrt(s) - 0.0599586817259432*sin(10.6415385122204*s) - 0.999306827268566) - tanh(asin(sech(17.2049441844683*s)))) - 1.36585028977422*sin(51.0727674445071*s) + 1.26109775598263*sin(51.4695471152235*s) + 0.515452361276361*sin(s*(acos(s) - 46.6177357352168)) + 22.2565825288712*sin(cos(7.16097575179141*s + 2.69555392274637)) + 0.476275859314223*cos(39.2824846709371*s) + 0.172038123247437*cos(63.2700744883016*s) - 38.2783771243806*asin(cos(acos(s) - 0.660224035864272)) + 25.10990298288'.replace("**","^")
            ...
            if expression_type_to_plot == "prefix":
                ...
                complete_rpn_expr = '30.47228105582914 x0 17.205653266345312 * + 4 x0 * x0 6.453017466332702 * x0 0.01270860997091583 - * 0.41753599573615535 x0 * 4 x0 * sin tanh * 0.26150588347842874 x0 arcsin cos * - 3.970780808510592 + * -16.474891100397233 x0 * x0 tanh asin arcsin * + 6.097060039845735 x0 asin x0 + sqrt * - 4.563112917427157 + * x0 0.7077873260367489 x0 - - 0.2732770516937082 x0 sqrt * 0.1425434896256179 10.6415385122204 x0 * sin * - 3.413113196758642 - * + x0 -17.150069520115206 * sech asin tanh - * -1.4431473276480822 51.0727674445071 x0 * sin * + -1.339647250339285 51.4695471152235 x0 * sin * - -0.5526745040925705 x0 x0 acos 46.6177357352168 - * sin * - -21.873332675361716 7.16097575179141 x0 * 0.44924108335673213 - cos sin * + 0.4765748945106632 39.270193042196944 x0 * cos * + 0.19840362798116964 -63.3624466252343 x0 * cos * + 39.54761188579861 x0 arccos -0.6606477247496182 + cos asin * - x0 0.7122369606603947 - -0.20295861242232952 0.28956957106436976 x0 2 - 85.89138216668816 x0 -16.199941613454808 * + * + cos * * - 0.02634913287785212 -0.010685036434860833 x0 * + 11.129043572587705 x0 -11.734345813067337 * + -0.04734740817048009 3.014078014652437 x0 -56 * * sin + * tanh * +'
