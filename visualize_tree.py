...
def test_visualize():
    ...
    if save:
        ...
        if pn_to_rpn:
            ...
            infix_expr = '(0.000200035130556368*x2 - 1.00527025890202)*(sin(x0 - 7.58841728944106e-10) + 3.52951350621945e-10)*(0.00878305351929222*x2 - 0.165156075111407*x3 + 3.66038179966832)*sin(x1 + 5.30180272667561*x3 + sin(10.6889021533267*x2) + 66.1480200387096)'.replace("**","^")
            ...
            if expression_type_to_plot == "prefix":
                ...
                complete_rpn_expr = '0.00020003506868668903 0 1.1061425463169367e-06 + x2 + * -1.005270257995713 + -1.129180066614862e-12 x0 + sin x2 x0 + -2.0058778908765135e-11 * + * 0.008783053924412336 -1.8560197257909573e-07 x2 + * -0.16515607557644987 2.4876909651974957e-08 x3 + * + 3.660381804944109 + * 8.969624803604539e-08 5.3018027262259215 x3 * + 10.688902153455777 x2 * sin + 6.07494780895592e-10 2.79892501983662e-10 x1 + + 66.14801995013538 + + sin *'
