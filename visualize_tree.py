...
def test_visualize():
    ...
    if save:
        ...
        if pn_to_rpn:
            ...
            infix_expr = '(s + acos(acos(sech(cos(s) - 0.96402913805394))) + 2.00010150959551*asin(sqrt(sech(tanh(s)))))*((s + 10.495159233974)*(3*s*(1.39736528760406*asin(cos(s)) - 0.136317215116906) + (0.604598147183608*s - 0.135494222205354)*(-s + sin(9.68908970669284*s) - 0.656836910570005) - (-0.26604070780876*acos(sin(s + 0.92107761945413)) - sech(12.2932790675658*s))*asin(s))*tanh(sqrt(s)) - (-1.30446655103543*asin(s) - 0.265712575458862)*acos(s) - (s**3 + 8.55371112939692*asin(s) + 4.97547977457452)*asin(sech(s - acos(s))) + acos(sin(3.77376678161015*s - 2.78914890530164)))'.replace("**","^")
            ...
            if expression_type_to_plot == "prefix":
                ...
                complete_rpn_expr = 'x0 x0 cos 0.96402913805394 - sech acos acos + 2.00010150959551 x0 tanh sech sqrt asin * + x0 10.495159233974 + 3 x0 * 1.39736528760406 x0 cos asin * 0.136317215116906 - * 0.604598147183608 x0 * 0.135494222205354 - x0 ~ 9.68908970669284 x0 * sin + 0.656836910570005 - * + -0.26604070780876 x0 0.92107761945413 + sin acos * 12.2932790675658 x0 * sech - x0 asin * - * x0 sqrt tanh * -1.30446655103543 x0 asin * 0.265712575458862 - x0 acos * - x0 3 ^ 8.55371112939692 x0 asin * + 4.97547977457452 + x0 x0 acos - sech asin * - 3.77376678161015 x0 * 2.78914890530164 - sin acos + *'
