...
def test_visualize():
    ...
    if save:
        ...
        if pn_to_rpn:
            ...
            infix_expr = '910.397276913756*s**2 + (0.366382982908602*(acos(s)*sech(s) + acos(tanh(s)) + 2.99908422397666)*(-8.06482169080269*s + (2*s + 0.858418335398135)*(-0.0310778226598244*s**2*(acos(s) + sech(4*acos(s))) + (asin(s) + 8.0100943104304)*(s*(-s + (0.716383833682647*s + 0.716383833682647*sin(s) - 0.952440817816097)*tanh(sin(4*s)) + cos(14.4822419995489*sqrt(s)) - 4.03158279900313) + s + 2.23769073217509*acos(sqrt(s)) - asin(asin(acos(sin(s + 0.994889699761734)))) + 7.16136736888724) - 1.42547140229722*acos(-cos(2.55747800491866*s + 6)) + asin(s) - 84.8123411667977*sech(s)) - (8.08033164436204*s - 14.2429580781579)*(-s*acos(1 - s) - 7.35419779086294*s + (1 - sin(9.55978346043853*s))*(sqrt(s) + 0.406898704961922) + 7.37323093580846) + 9.25407591481792*tanh(4*s - 1) - acos(sech(cos(acos(s) + 0.770736556144219))) - 63.1335708208355*sech(9.50777910063498*s + 0.648625307226131) - 44.9106606238174) + 0.713084631656438*sech(sin(cos(7.99942348701375*s + 8.00023973396972))))*(asin(sech(tanh(acos(s) - 0.98487956174973))) + 4)'.replace("**","^")
            ...
            if expression_type_to_plot == "prefix":
                ...
                complete_rpn_expr = "25.264433918858277 2.1058329667813553 -4.00384411976911 -0.5839960535713218 x0 x0 + - * * x0 x0 -4.69280721645241 x0 tanh asin arcsin * * x0 x0 0.28549567287001987 + * -1.352343836079487 x0 4 x0 * sin tanh * * ~ x0 asin cos - 0.3481730196105975 * 5.9826096380313505 + * + 1.7958951750142216 x0 sqrt x0 asin + sqrt * - 0.47072378558576894 + 4.000689458748791 * * x0 0.8409565071321176 - 0.1804660458627765 9.55978346043853 x0 * sin ~ x0 sqrt -0.35905603343530945 * - * 1.4618845198082118 - * + 4 * x0 13.415289139283663 * sech arcsin tanh - * -11.612625804502091 7.99942349483886 x0 * -2.251581050894711 - cos ~ sin * + x0 arccos 1.0146795657942083 - cos arcsin -38.17181343242091 * + + 0.028270216028607312 x0 -50.94007268568142 * sin * - x0 -36.820770402671656 * cos -0.02918152349299525 * + -0.01792375403274644 x0 66.73377491991278 * cos * + x0 -44.35378377073075 x0 arccos + * sin 0.024097035129303626 * + 0.007914274685258656 x0 -58.33364310094479 * sin * +"
