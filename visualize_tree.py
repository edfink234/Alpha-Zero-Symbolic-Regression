...
def test_visualize():
    ...
    if save:
        ...
        if pn_to_rpn:
            ...
            infix_expr = '(0.00020548479822318*x2 + 0.000200035068686689*sin(x2) - 1.00527025799571)*(0.00878305392441234*x2 - 0.16515607557645*x3 - 0.0001364999937805*sin(x2) + 3.66041580580201)*sin(x0)*sin(-x1 + 5.30180272622592*x3 + sin(10.6889021534558*x2) + 59.8648299501354)'.replace("**","^")
            ...
            if expression_type_to_plot == "prefix":
                ...
                complete_rpn_expr = '-0.000100791315410173 x3 sin -0.4314186657656249 x2 * + * -0.7804663737709057 + 0.9996066571884268 -2.1800323765729803e-10 x0 + sin * ~ * -0.16506007257280858 1.0000001690945002 x3 ~ * x3 1.9443457701816629 + 1.0000000242997562 x3 * + + * -0.010052807626991568 x2 -2.557279356185078 + -2.6200543093088995 + * 4.3561912541265535 + + * 2.5707958554135955 0.7853978286006916 x2 x3 * * * 1.1801175501287325e-05 x0 + x0 ~ + 2.0314514898049403 x2 x3 * + + + 3.142940855410066 x1 ~ -0.999999393152779 + + 7.448132664310183 + + sin * 1.9528687519211347 x3 * -0.18079330636500487 x2 * + -1.0460355020183312 * x3 sin -4.294902147840091 x2 + * 19.843575019505305 + + -0.0003489234414567007 34.27291836384993 x2 + -0.15674536325381436 x2 * * * -0.02931457210915629 + * 0.2778142262610242 x2 * 1.6743164536673432 + 0.04429926407299252 x3 + 0.8025002170374489 * + sin -0.027778837464214643 x2 * 0.22917713722717975 + x3 1.6427413731127927 * sin * sin + * -0.036981340360795575 7.573688142676603e-05 x2 + + 0.14281903686679137 x3 sin * + 2.3650325481851913 x3 0.5798553117678674 * + sin + 7.333566404386932 x3 3.5849352556167213 * + -0.0005217069377446043 * -0.10877845872103128 + * -0.18975395292751068 16.723773097206823 x2 + * x2 -0.00021055994058814524 * 0.0011319289521094485 + * x3 x3 * x3 x0 + + x0 ~ 1.0004351207501196 * + * 0.4305049702704657 x2 * sin 0.0663646494164463 * 0.6604807112660769 + + + + +'
