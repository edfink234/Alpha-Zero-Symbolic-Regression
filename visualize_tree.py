...
#        plot_pn_expression_tree("+ eps / 1 - 1 exp ~ f".split(), save = save)
        plot_rpn_expression_tree("9740.372938 0 + -1405.000000 x18 / + x20 x5 + -15659.107062 0 + * +".split(), save = save, tolatex = True, to_pdf = True, filename = "Example.pdf", include_expression_in_title = False)
