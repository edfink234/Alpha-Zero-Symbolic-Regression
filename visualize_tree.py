...
#        print(complete_tree("".split(), "prefix"))
        ...
        complete_rpn_expr = complete_tree("x6 0.00621 - x17 9741 + + 1 x13 / + 232 15666.000000 x6 ^ / x18 * 2.0200101e+07 x6 + cos ^ - x21 tanh x0 4 - * 59 1 x7 + + x11 x15 ^ - ^ - x25 3.4288275429960554e+302 - x1 336 - -100 ^ 0.00621 x18 25.4 ^ ^ + x13 x22 + 9736 / x18 + 0.00621 x20 / 2 + - ^ / + x6 2.176586002694007 / x8 x0 + -2.64 x2 + - ^ 4.724366706875754 36.293228 x10 - ^ x5 6075 * x20 + + + x17 38 x8 + x11 * / x24 x12 + 256.5 / 92.45173100000001 + x23 - ^ + x19 0.00621 + 26.90232091662481 * -806.4403540000001 + -53.92119644678062 x22 * x21 acos x24 x18 - -18327.436844999997 + + + + * +".split(), "postfix")
