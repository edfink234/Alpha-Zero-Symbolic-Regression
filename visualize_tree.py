...
#                plot_pn_expression_tree("~ * * sech * x 1 sech * x 1 1".split(), block=True, save = save)
#            plot_pn_expression_tree("1 x cos 1 * + ~".split(), block=True, save = save)
                plot_rpn_expression_tree("x y / tanh x sin ^ x y / tanh x sin ^ x y / tanh ln x cos 1 * * x y / sech x y / sech * y x 0 * - y y * / * x y / tanh / x sin * + * x * +".split(), block=True, save = save)
