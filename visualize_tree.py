    ...
    if save:
        ...
        if pn_to_rpn:
            ...
            if expression_type_to_plot == "prefix":
                ...
                complete_rpn_expr = '0.6365941221448377 x0 sin * ~ -0.1650601107284825 x3 ~ x3 sech + x3 2.0241722030939244 + 1.0000440102816577 x3 * + + * x3 ~ x3 x2 * * 6.409558343827763e-05 * x0 tanh 1.3490901151040035e-06 * 4.098212381014165 + + + * 4.574547677880055 0.8797565521407752 x2 x3 * * * x0 x1 sin ~ * + 2.4364576349535887 x1 ~ -1.0000586050370963 + + 8.440046780949201 + + sin * x2 sech x3 ~ + 0.6710633010022027 x3 ~ * + x0 x1 sin * x2 sech 24.48885940684052 + + + -0.018762151418256916 * 0.14692877380175087 x2 * 3.3716404659000094 + 0.5157566088189532 x3 * + sin 0.9424139579211748 x1 sin x0 ~ * + sin + * 0.5430059163843983 x2 20.915158953413112 + x3 -0.23287434772173943 * + * 1.923415297402251 x3 0.5000325108988808 * + sin + x0 0.0023456346176391465 * tanh x1 sin -0.0002271127692255566 + * x2 x2 ~ + -0.26457192942663044 + + * x0 x2 x3 + * -0.0013534579194734526 * x0 ~ 1.7585615689604455 * sin * x3 x2 + ~ x3 0.1687343359750209 + + 3.102446360968321 x2 ~ -1.0709887034920822 * + + + + + +'
