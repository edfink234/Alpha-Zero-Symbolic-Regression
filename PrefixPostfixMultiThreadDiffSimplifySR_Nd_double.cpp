...
{
    /*
     Best score = 6.27315e-05, SNE = 15940
     Squared-norm error for each equation: 15926.1 13.8627 0
     Best expression = ((((((0.010000 + 10.28319) ^ (0.010000 + x0)) * ((0 - 4) + (4 + 2.714063472005533e-13))) + (((0 + 4.692820413780688e-06) * (0.000000 - x1)) + ((0.010000 / 6.283190) + (0 + 0.7049172460634555)))) - ((((0 - x1) + (x1 + 0.999329299739067)) * sin((0.010000 + x1))) * (((0 + 0) + (0 + 0.9989466681769272)) * sin((0 + x0))))) - (((((6.283190 - 0.010000) + (1 + x1)) / (~(0.010000) + (0 + -10.85907152907618))) * (~(sech(10.000000)) + ((0 - 1) + (1 + 0.019659199307306502)))) + ((((0 + x0) / (x0 + 2)) ^ ((x0 + 0.010000) + (0 + 6.333189999999999))) + (((0 + 0.010000) ^ (10.000000 / x0)) + (sech(10.000000) + (0 + 0.09367884443582758))))))
     Best expression (original format) = 0.010000 10.28319 + 0.010000 x0 + ^ 0 4 - 4 2.714063472005533e-13 + + * 0 4.692820413780688e-06 + 0.000000 x1 - * 0.010000 6.283190 / 0 0.7049172460634555 + + + + 0 x1 - x1 0.999329299739067 + + 0.010000 x1 + sin * 0 0 + 0 0.9989466681769272 + + 0 x0 + sin * * - 6.283190 0.010000 - 1 x1 + + 0.010000 ~ 0 -10.85907152907618 + + / 10.000000 sech ~ 0 1 - 1 0.019659199307306502 + + + * 0 x0 + x0 2 + / x0 0.010000 + 0 6.333189999999999 + + ^ 0 0.010000 + 10.000000 x0 / ^ 10.000000 sech 0 0.09367884443582758 + + + + + -
     ```
    ...
    void SwiftHohenbergTest(int random_seed, const char* algorithm, double time)
    {
        ...
        else
        {
            SimulatedAnnealing(SwiftHohenberg /*differential equation to solve*/,
                ...
                {} /*custom features that the SR-found equations are required to contain*/,
                "" /*filename to save current best expression found (instead of outputting them to standard out*/,
                {split("0.010000 10.28319 + 0.010000 x0 + ^ 0 4 - 4 2.714063472005533e-13 + + * 0 4.692820413780688e-06 + 0.000000 x1 - * 0.010000 6.283190 / 0 0.7049172460634555 + + + + 0 x1 - x1 0.999329299739067 + + 0.010000 x1 + sin * 0 0 + 0 0.9989466681769272 + + 0 x0 + sin * * - 6.283190 0.010000 - 1 x1 + + 0.010000 ~ 0 -10.85907152907618 + + / 10.000000 sech ~ 0 1 - 1 0.019659199307306502 + + + * 0 x0 + x0 2 + / x0 0.010000 + 0 6.333189999999999 + + ^ 0 0.010000 + 10.000000 x0 / ^ 10.000000 sech 0 0.09367884443582758 + + + + + -")} /*seed expressions*/,
