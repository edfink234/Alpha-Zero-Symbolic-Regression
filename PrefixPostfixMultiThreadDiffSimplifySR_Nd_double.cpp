...
//    puts("called SwiftHohenberg");
    ...
    Depth = 9:
        Best score = 0.000546142, SNE = 1830.03
        Squared-norm error for each equation: 1823.17 2.65622 4.20259
        Best expression = ((((((((0.01 + x0) + 0.31044597185803335) + sech((x1 - 1.8378778132946323))) ^ ((1.053734854911715 - ((1 + x0) / 10)) + 11.18652836028018)) * 2.714063572022206e-13) + 0.7906724620892133) - (((0.9998848754538172 ^ (arcsin(tanh(x0)) / (0.7568024953079282 / (x0 ^ 4)))) * (sin(~((0.9999999999889888 * x1))) * 0.894444312545578)) * (0.7128603825660021 * cos(asin(cos(x0)))))) - ((((((x0 ^ 1.0000908039817697) + (x0 ^ ((1 + x0) ^ 0.01))) ^ ((0.0101 ^ (6.28319 / (2 + x0))) + 7.593995213035263)) * ((0.28581161447490727 ^ (x0 + 10.01)) * (((sech(x0) ^ (x0 / 10)) + sin(ln(x0))) - sin((x1 + cos(x1)))))) + (((-6065.37025205674 + (((2 - x1) + -336.7979584141763) + -535.4941638040133)) / ((~(x1) * -2) - (((4 + x1) * ~(x0)) + (4 + (x0 + -1.920169404883566e+06))))) + -0.0634947826204692)) + (((((0.3333333333333333 + (x0 + 0.010000)) ^ 0.9801980198019802) / ((0.02 + (0.010000 + x0)) + (((x1 + x1) * (0.01 ^ x0)) + 1.537923178056138))) ^ ((sin(x0) + (0.13542608309595053 + (0.1 + x0))) * (sin((cos(x1) + (6.28319 + x1))) + (10 / (0.01 + x0))))) + (-1e-06 + ((7.243274829196931 / (((x0 + 1) + (x1 + 10)) + (10 + (x0 + -10444.087753901069)))) + -0.014502994696159215)))))
        Best expression (original format) = 0.01 x0 + 0.31044597185803335 + x1 1.8378778132946323 - sech + 1.053734854911715 1 x0 + 10 / - 11.18652836028018 + ^ 2.714063572022206e-13 * 0.7906724620892133 + 0.9998848754538172 x0 tanh arcsin 0.7568024953079282 x0 4 ^ / / ^ 0.9999999999889888 x1 * ~ sin 0.894444312545578 * * 0.7128603825660021 x0 cos asin cos * * - x0 1.0000908039817697 ^ x0 1 x0 + 0.01 ^ ^ + 0.0101 6.28319 2 x0 + / ^ 7.593995213035263 + ^ 0.28581161447490727 x0 10.01 + ^ x0 sech x0 10 / ^ x0 ln sin + x1 x1 cos + sin - * * -6065.37025205674 2 x1 - -336.7979584141763 + -535.4941638040133 + + x1 ~ -2 * 4 x1 + x0 ~ * 4 x0 -1.920169404883566e+06 + + + - / -0.0634947826204692 + + 0.3333333333333333 x0 0.010000 + + 0.9801980198019802 ^ 0.02 0.010000 x0 + + x1 x1 + 0.01 x0 ^ * 1.537923178056138 + + / x0 sin 0.13542608309595053 0.1 x0 + + + x1 cos 6.28319 x1 + + sin 10 0.01 x0 + / + * ^ -1e-06 7.243274829196931 x0 1 + x1 10 + + 10 x0 -10444.087753901069 + + + / -0.014502994696159215 + + + + -
     ```
...
for i in range(len(consts)):
        ...
        else
        {
            SimulatedAnnealing(WierdTrackFitter /*differential equation to solve*/,
                ...
                {} /*custom features that the SR-found equations are required to contain*/,
                "WierdTrackSR.txt", // "" /*filename to save current best expression found (instead of outputting them to standard out)*/
                std::vector<int>{271} /*optional max-sizes of each of the expressions in the generated solution*/,
                {/*split(seed_exprs[track_idx])*/} /*function-vector to be added to each funtion-vector found by symbolic-regressor in each iteration; logic is user-implemented*/,
                "vector" /*evaluation type: can be "dag", "scalar", or "vector"*/,
                1000000 /*`print_every` number of expressions generated before thread prints to standard out*/,
                false /*whether to explicitly print out the result of plugging in the best found expression into the system being solved*/,
