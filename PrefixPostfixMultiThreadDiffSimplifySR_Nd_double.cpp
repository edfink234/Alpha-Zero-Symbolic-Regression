...
//    puts("called SwiftHohenberg");
    ...
    Depth = 9:
        Best score = 0.000608229, SNE = 1643.12
        Squared-norm error for each equation: 1643.11 0.012211 7.62223e-09
        Best expression = ((((((((0.009999833334166664 + (0.01 + x0)) + 0.3333333333333333) + sech((sin(x1) - 1.5707963267948966))) ^ ((1.043734854911715 - ((1 + x0) / 10)) + 11.186528193614347)) * 2.714063472005533e-13) + 0.795812295700981) - (((0.9998848754538172 ^ (arcsin(tanh(x0)) / (0.693159882516959 / ((0.01 + x0) ^ 4)))) * (sin(~(x1)) * 0.8654748654118212)) * (0.7076432420395036 * cos(asin(cos(x0)))))) - ((((((x0 ^ 1.0000908139817695) + (x0 ^ ((1 + x0) ^ 0.01))) ^ ((0.015 ^ (6.28319 / (2 + x0))) + 7.593995213035263)) * ((0.2858069216544935 ^ ((9.079985933781724e-05 + x0) + 10.01)) * (((sech(x0) ^ (x0 / 10)) + sin(ln(x0))) - sin(((6.28319 + x1) + cos(x1)))))) + ((((~(x1) * 6.28319) + -5852.197463167629) / ((((4 + x0) + x0) - ((4 - x1) + (1 - x1))) - ((9 * ~(x0)) + -1.920168058527187e+06))) + -0.0671249720125785)) + (((((0.3333333333333333 + x0) ^ 0.9801980198019802) / ((0.02000470282041378 + (0.03661899347368653 + (0.010000 + x0))) + (((x1 + 20) * (0.01 ^ x0)) + 1.547923178056138))) ^ (((0.013734854911714877 + (0.01 + sin(x0))) + (0.14542608309595054 + (0.1 + (0.01 + x0)))) * (sin((cos(x1) + x1)) + (10 / (0.15915482422145438 + (0.01 + x0)))))) + ((ln((0.9999500004166652 ^ (6.28319 + x1))) + -0.0032000017267332587) + ((7.260774829196931 / (((x0 - 10) + 1.5607961601207294) + ((6.28319 + x0) + -10444.087753901067))) + -0.014502929186510107)))))
        Best expression (original format) = 0.009999833334166664 0.01 x0 + + 0.3333333333333333 + x1 sin 1.5707963267948966 - sech + 1.043734854911715 1 x0 + 10 / - 11.186528193614347 + ^ 2.714063472005533e-13 * 0.795812295700981 + 0.9998848754538172 x0 tanh arcsin 0.693159882516959 0.01 x0 + 4 ^ / / ^ x1 ~ sin 0.8654748654118212 * * 0.7076432420395036 x0 cos asin cos * * - x0 1.0000908139817695 ^ x0 1 x0 + 0.01 ^ ^ + 0.015 6.28319 2 x0 + / ^ 7.593995213035263 + ^ 0.2858069216544935 9.079985933781724e-05 x0 + 10.01 + ^ x0 sech x0 10 / ^ x0 ln sin + 6.28319 x1 + x1 cos + sin - * * x1 ~ 6.28319 * -5852.197463167629 + 4 x0 + x0 + 4 x1 - 1 x1 - + - 9 x0 ~ * -1.920168058527187e+06 + - / -0.0671249720125785 + + 0.3333333333333333 x0 + 0.9801980198019802 ^ 0.02000470282041378 0.03661899347368653 0.010000 x0 + + + x1 20 + 0.01 x0 ^ * 1.547923178056138 + + / 0.013734854911714877 0.01 x0 sin + + 0.14542608309595054 0.1 0.01 x0 + + + + x1 cos x1 + sin 10 0.15915482422145438 0.01 x0 + + / + * ^ 0.9999500004166652 6.28319 x1 + ^ ln -0.0032000017267332587 + 7.260774829196931 x0 10 - 1.5607961601207294 + 6.28319 x0 + -10444.087753901067 + + / -0.014502929186510107 + + + + -
     ```
x = "(((((((x0 + -0.01) + sech((x1 - 1.3862943611198906))) ^ 11.13652836028018) * 2.714063572022206e-13) + (((((0.15915482422145438 + x0) ^ ((1 / x0) + 6.29319)) * 1e-08) + 0.013906583356672894) + 0.7493736126143709)) - (((0.9998848754538172 ^ (arcsin(tanh(x0)) / (0.7568024953079282 / (x0 ^ 4)))) * (sin(~((0.9999999999889888 * x1))) * 0.9171523356672744)) * (0.7727863849639187 * cos(asin(cos(x0)))))) - ((((((0.003734854911714874 + x0) + (0.01 + (4.692820413780688e-06 + x0))) ^ ((0.01 ^ (6.28319 / (0.010000 + x0))) + 7.570169558264211)) * ((0.28580222883407974 ^ ((0.01 + x0) + 10.01)) * (((0.01 ^ x0) + 1) - sin(x1)))) + (((0.6931471805599453 + (x1 + (4 + x1))) / (((100 + x1) / 0.005) - (0.9999930254050717 - (535.4941684968337 + (x0 + 1.9196309107150692e+06))))) + ((9.669871137523926e-07 + (x1 * -1.1011191958292926e-11)) + -0.06767485271943648))) + (((((0.2658022288340797 + (0.03661899347368653 + (x0 + 0.010000))) ^ 0.9801980198019802) / ((0.03661899347368653 + (0.01 + (0.010000 + x0))) + 1.527923178056138)) ^ ((sin(x0) + (0.03661899347368653 + x0)) * (sin(x1) + (10 / (0.01 + x0))))) + (((1.5707963267948966 * (0.8414709848078965 * (x1 - 1))) / -10469.47681) + -0.014502994696159217))))"
...
for i in range(len(consts)):
        ...
        else
        {
            SimulatedAnnealing(WierdTrackFitter /*differential equation to solve*/,
                2 /*number of equations in differential equation system*/,
                data /*data used to solve differential equation*/,
                std::vector<int>{43} /*fixed depths of generated solution*/,
                "postfix" /*expression representation*/,
                0 /*num_consts_diff: number of constants in differential equation*/,
                "LevenbergMarquardt" /*fit method if expression contains const tokens*/,
                5 /*number of fit iterations*/,
                ...
                {} /*custom features that the SR-found equations are required to contain*/,
                "WierdTrackSR.txt", // "" /*filename to save current best expression found (instead of outputting them to standard out)*/
                std::vector<int>{328} /*optional max-sizes of each of the expressions in the generated solution*/,
                {/*split(seed_exprs[track_idx])*/} /*function-vector to be added to each funtion-vector found by symbolic-regressor in each iteration; logic is user-implemented*/,
                "vector" /*evaluation type: can be "dag", "scalar", or "vector"*/,
                1000000 /*`print_every` number of expressions generated before thread prints to standard out*/,
                false /*whether to explicitly print out the result of plugging in the best found expression into the system being solved*/,
