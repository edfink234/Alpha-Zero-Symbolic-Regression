...
std::vector<std::vector<std::string>> WildfireSpreadTS(Board& x, bool fit)
{
    ...
    /*
     Best score = 4.42095e-07, SNE = 2.26196e+06
     Squared-norm error for each equation: 2.26196e+06
     Best expression = (((((((x6 - 0.006210) + 9741) + (1 / x13)) - ((77888 * x22) ^ cos((20200101.000000 + x6)))) - ((8.851731000000001 / (0.00621 + x6)) ^ ((4.372938 + x7) - (x20 + 279.200012)))) + ((x25 - 3.4288275429960554e+302) / ((((x15 + x1) ^ -100) + x5) ^ ((0.051731 + x18) - ((0.006210 / x20) + 2))))) + ((((((x22 * 8.800000) + (267.200012 ^ x20)) ^ ((x8 + x0) - (-2.640000 + x2))) + ((2.0200101e+07 ^ x15) + x20)) + ((x17 / ((38.000000 + x8) * x11)) ^ (92.45173100000001 - x23))) * ((((x19 + 0.00621) * (39.312500 - x21)) + -818.627062) + ((-54 * x22) + (acos(x21) + -18327.436844999997)))))
     Best expression (original format) = x6 0.006210 - 9741 + 1 x13 / + 77888 x22 * 20200101.000000 x6 + cos ^ - 8.851731000000001 0.00621 x6 + / 4.372938 x7 + x20 279.200012 + - ^ - x25 3.4288275429960554e+302 - x15 x1 + -100 ^ x5 + 0.051731 x18 + 0.006210 x20 / 2 + - ^ / + x22 8.800000 * 267.200012 x20 ^ + x8 x0 + -2.640000 x2 + - ^ 2.0200101e+07 x15 ^ x20 + + x17 38.000000 x8 + x11 * / 92.45173100000001 x23 - ^ + x19 0.00621 + 39.312500 x21 - * -818.627062 + -54 x22 * x21 acos -18327.436844999997 + + + * +
     ```
        ...
        func = '(((((9740 + (1.000000 / x13)) - ((x22 * x22) ^ cos(x6))) - ((8.851731000000001 / x6) ^ ((4.372938 + x7) - 279.200012))) + ((-3.225653 - (1075 ^ x10)) / (x5 ^ (x18 - 2)))) + ((((x24 ^ (x0 - x2)) + ((20200101.000000 ^ x15) + x20)) + ((x17 / (292.600006 * x11)) ^ (91.4 - x23))) * ((((x19 + 0.006210) * 25.4) + -820.627062) + (((x23 + -330) * x22) + (acos(x21) + -18327.436844999997)))))'
        func = func.replace("^","**")
