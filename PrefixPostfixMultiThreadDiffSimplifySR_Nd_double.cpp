    ...
    track_idx = 1:
     ...
     track_idx = 2:
        ...
        depth = 57, maxsize = 605:
            Best score = 0.0156079, SNE = 63.0702
            Squared-norm error for each equation: 16.7664 46.3038
...
//    puts("called SwiftHohenberg");
    ...
    Depth = 10:
        Best score = 0.000638488, SNE = 1565.2
        Squared-norm error for each equation: 1565.1 0.00903045 0.0904808
        Best expression = (((((((x0 + 0.435196050124308) + cos((sin((6.28319 + x1)) - 0.6931471805599453))) ^ (sin(sqrt(x0)) + 11.18686365624225)) * 2.7140635720055333e-13) + ((2.7140689318205365e-13 * ((1.911817167726296 + (2.5701256265339634 + (6.28319 + x1))) ^ (cos(x1) - ~(sech(x1))))) + 0.7961011355317003)) - (((0.9998848754538172 ^ (arcsin(tanh(x0)) / ((sin(sech(x0)) + 0.6931471805599453) / ((0.01 + x0) ^ 4)))) * (sin(~(x1)) * 0.8654678907925701)) * (0.7073944876092242 * cos(asin(cos(x0)))))) - ((((((x0 ^ 0.9999930254050716) + ((-5.000083335568168e-05 + (x0 ^ 0.9999930254050717)) ^ (x0 ^ 0.01))) ^ ((0.015090799859337816 ^ (6.29319 / (2 + x0))) + 7.593328980574705)) * ((0.2858069216544935 ^ ((9.079985933781724e-05 + x0) + 10.010090799859338)) * (((sech(x0) ^ (x0 / 11)) + sin(ln(x0))) - sin(((0.06283190000000001 + x1) + cos(x1)))))) + (((((x1 - 1.1750996556597613) + ((x1 + x1) + -14)) + (((x1 + -4.605170185988091) + -10) - (((0.01 + x1) + 1.5707963267948966) * 11.727308470923548))) / (((0.00999966667999946 / x0) ^ (x0 ^ 1.5607961601207294)) - (0.6931471805599453 + (1.3862943611198906 - (~(x1) + 1.9201520944996069e+06))))) + ((((((0.01 + x1) + (x1 - 6.28319)) + (x0 - (6.28319 ^ x0))) * (~(x0) + (-0.8390715290764524 + x1))) / (((16 ^ x1) - ((x0 + x1) * exp(x0))) + ((2 ^ x1) + 3.645259197930204e+11))) + -0.0681655773115492))) + (((((0.3333474117945746 + ((sin(x1) * 0.010000166674167114) + (0.009999833334166664 + x0))) ^ 0.9800980198019802) / ((0.019950000833311075 + (0.04661899347368653 + (0.01 + x0))) + ((((x0 + x0) + (x0 + 30)) * (0.01 ^ x0)) + 1.5579233447303051))) ^ (((((0.01 ^ exp(x1)) + 0.02746970982342975) + (0.01 + sin(x0))) + (0.16416093800766546 + (0.10999983333416667 + (0.01 + x0)))) * (sin((cos(x1) + (0.01 + x1))) + (9.99 / (0.1691548242214544 + (0.01 + (0.01 + x0))))))) + (((((-4.60515351871028 + x1) - (6.28319 - x1)) + (46.01950782537083 + (tanh(ln(x0)) - 17.843986160120732))) ^ -10) + ((10.789113539894606 / (((x0 - -4.605170185988091) * 0.9092974268256816) + ((1.5607961601207294 + x0) + -10431.243767740949))) + ((6.123233995736766e-17 * (0.009154748368421632 * (9.079985933781725e-05 / (2 - x1)))) + -0.01446122107888873))))))
        Best expression (original format) = x0 0.435196050124308 + 6.28319 x1 + sin 0.6931471805599453 - cos + x0 sqrt sin 11.18686365624225 + ^ 2.7140635720055333e-13 * 2.7140689318205365e-13 1.911817167726296 2.5701256265339634 6.28319 x1 + + + x1 cos x1 sech ~ - ^ * 0.7961011355317003 + + 0.9998848754538172 x0 tanh arcsin x0 sech sin 0.6931471805599453 + 0.01 x0 + 4 ^ / / ^ x1 ~ sin 0.8654678907925701 * * 0.7073944876092242 x0 cos asin cos * * - x0 0.9999930254050716 ^ -5.000083335568168e-05 x0 0.9999930254050717 ^ + x0 0.01 ^ ^ + 0.015090799859337816 6.29319 2 x0 + / ^ 7.593328980574705 + ^ 0.2858069216544935 9.079985933781724e-05 x0 + 10.010090799859338 + ^ x0 sech x0 11 / ^ x0 ln sin + 0.06283190000000001 x1 + x1 cos + sin - * * x1 1.1750996556597613 - x1 x1 + -14 + + x1 -4.605170185988091 + -10 + 0.01 x1 + 1.5707963267948966 + 11.727308470923548 * - + 0.00999966667999946 x0 / x0 1.5607961601207294 ^ ^ 0.6931471805599453 1.3862943611198906 x1 ~ 1.9201520944996069e+06 + - + - / 0.01 x1 + x1 6.28319 - + x0 6.28319 x0 ^ - + x0 ~ -0.8390715290764524 x1 + + * 16 x1 ^ x0 x1 + x0 exp * - 2 x1 ^ 3.645259197930204e+11 + + / -0.0681655773115492 + + + 0.3333474117945746 x1 sin 0.010000166674167114 * 0.009999833334166664 x0 + + + 0.9800980198019802 ^ 0.019950000833311075 0.04661899347368653 0.01 x0 + + + x0 x0 + x0 30 + + 0.01 x0 ^ * 1.5579233447303051 + + / 0.01 x1 exp ^ 0.02746970982342975 + 0.01 x0 sin + + 0.16416093800766546 0.10999983333416667 0.01 x0 + + + + x1 cos 0.01 x1 + + sin 9.99 0.1691548242214544 0.01 0.01 x0 + + + / + * ^ -4.60515351871028 x1 + 6.28319 x1 - - 46.01950782537083 x0 ln tanh 17.843986160120732 - + + -10 ^ 10.789113539894606 x0 -4.605170185988091 - 0.9092974268256816 * 1.5607961601207294 x0 + -10431.243767740949 + + / 6.123233995736766e-17 0.009154748368421632 9.079985933781725e-05 2 x1 - / * * -0.01446122107888873 + + + + + -
...
for i in range(len(consts)):
        ...
        else
        {
            SimulatedAnnealing(WierdTrackFitter /*differential equation to solve*/,
                2 /*number of equations in differential equation system*/,
                data /*data used to solve differential equation*/,
                std::vector<int>{57} /*fixed depths of generated solution*/,
                "postfix" /*expression representation*/,
                0 /*num_consts_diff: number of constants in differential equation*/,
                "LevenbergMarquardt" /*fit method if expression contains const tokens*/,
                5 /*number of fit iterations*/,
                ...
                {} /*custom features that the SR-found equations are required to contain*/,
                "WierdTrackSR.txt", // "" /*filename to save current best expression found (instead of outputting them to standard out)*/
                std::vector<int>{605} /*optional max-sizes of each of the expressions in the generated solution*/,
                {/*split(seed_exprs[track_idx])*/} /*function-vector to be added to each funtion-vector found by symbolic-regressor in each iteration; logic is user-implemented*/,
                "vector" /*evaluation type: can be "dag", "scalar", or "vector"*/,
                1000000 /*`print_and_check_fit_dict_every`: number of expressions generated before thread prints to standard out and, if `use_const_pieces == true && Board::expression_dict.size() == Board::max_expression_dict_sz`, clears `Board::expression_dict`*/,
                false /*whether to explicitly print out the result of plugging in the best found expression into the system being solved*/,
