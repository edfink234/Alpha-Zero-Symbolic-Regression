...
//    puts("called SwiftHohenberg");
    ...
    Depth = 10:
        Best score = 0.000634313, SNE = 1575.51
        Squared-norm error for each equation: 1575.41 0.00967327 0.0936173
        Best expression = (((((((x0 + 0.44519605012430796) + cos((sin(x1) - 0.6931471805599453))) ^ (sin(sqrt(x0)) + 11.186528193614349)) * 2.7140635720055333e-13) + ((2.714063472005533e-13 * ((2.901817167726296 + (2.5701256265339634 + (6.28319 + x1))) ^ (cos(x1) - ~(sech(x1))))) + 0.796000037462495)) - (((0.9998848754538172 ^ (arcsin(tanh(x0)) / ((sech(x0) + 0.6931471805599453) / ((0.01 + x0) ^ 4)))) * (sin(~((x1 - 4.692820413780688e-06))) * 0.8654678907925701)) * (0.7073944876092242 * cos(asin(cos(x0)))))) - ((((((x0 ^ 0.9999930254050716) + ((-5.000083335568168e-05 + x0) ^ ((1 + x0) ^ 0.01))) ^ ((0.015090799859337816 ^ (6.29319 / (2 + x0))) + 7.593328980574705)) * ((0.2858069216544935 ^ ((9.079985933781724e-05 + x0) + 10.010090799859338)) * (((sech(x0) ^ (x0 / 10)) + sin(ln(x0))) - sin(((0.01 + x1) + cos(x1)))))) + ((((x1 + ((x1 + x1) + -14)) + (((x1 + x1) + -10) - ((x1 + 1.5707963267948966) * 12.56638))) / (((0.00999966667999946 / x0) ^ (x0 ^ 1.5607961601207294)) - (-2.94709052124062 + ((x0 * (6.28319 + x1)) + (~(x1) + 1.9201520944996069e+06))))) + (((((0.01 + x0) + (x0 - (6.28319 ^ x0))) * (~(x0) + x1)) / (((16 ^ x1) - 23.02585092994046) + 3.6452591979218134e+11)) + -0.06816548191850429))) + (((((0.33334271897416085 + ((sin(x1) * 0.010000166674167114) + (0.009999833334166664 + x0))) ^ 0.9801980198019802) / ((0.01994999916664432 + (0.04661899347368653 + (0.01 + x0))) + ((((x0 + x0) + 30) * (0.01 ^ x0)) + 1.547923178056138))) ^ (((((0.01 ^ exp(x1)) + 0.02746970982342975) + (0.01 + sin(x0))) + (0.16042608309595058 + (0.10999983333416667 + (0.01 + x0)))) * (sin((cos(x1) + (0.01 + x1))) + (9.99 / (0.1691548242214544 + (0.01 + (0.01 + x0))))))) + (3.395317409551931e-05 + ((10.761594155955764 / (((x0 - -4) * 0.9092974268256816) + (x0 + -10434.804559208249))) + -0.01446121695658156)))))
        Best expression (original format) = x0 0.44519605012430796 + x1 sin 0.6931471805599453 - cos + x0 sqrt sin 11.186528193614349 + ^ 2.7140635720055333e-13 * 2.714063472005533e-13 2.901817167726296 2.5701256265339634 6.28319 x1 + + + x1 cos x1 sech ~ - ^ * 0.796000037462495 + + 0.9998848754538172 x0 tanh arcsin x0 sech 0.6931471805599453 + 0.01 x0 + 4 ^ / / ^ x1 4.692820413780688e-06 - ~ sin 0.8654678907925701 * * 0.7073944876092242 x0 cos asin cos * * - x0 0.9999930254050716 ^ -5.000083335568168e-05 x0 + 1 x0 + 0.01 ^ ^ + 0.015090799859337816 6.29319 2 x0 + / ^ 7.593328980574705 + ^ 0.2858069216544935 9.079985933781724e-05 x0 + 10.010090799859338 + ^ x0 sech x0 10 / ^ x0 ln sin + 0.01 x1 + x1 cos + sin - * * x1 x1 x1 + -14 + + x1 x1 + -10 + x1 1.5707963267948966 + 12.56638 * - + 0.00999966667999946 x0 / x0 1.5607961601207294 ^ ^ -2.94709052124062 x0 6.28319 x1 + * x1 ~ 1.9201520944996069e+06 + + + - / 0.01 x0 + x0 6.28319 x0 ^ - + x0 ~ x1 + * 16 x1 ^ 23.02585092994046 - 3.6452591979218134e+11 + / -0.06816548191850429 + + + 0.33334271897416085 x1 sin 0.010000166674167114 * 0.009999833334166664 x0 + + + 0.9801980198019802 ^ 0.01994999916664432 0.04661899347368653 0.01 x0 + + + x0 x0 + 30 + 0.01 x0 ^ * 1.547923178056138 + + / 0.01 x1 exp ^ 0.02746970982342975 + 0.01 x0 sin + + 0.16042608309595058 0.10999983333416667 0.01 x0 + + + + x1 cos 0.01 x1 + + sin 9.99 0.1691548242214544 0.01 0.01 x0 + + + / + * ^ 3.395317409551931e-05 10.761594155955764 x0 -4 - 0.9092974268256816 * x0 -10434.804559208249 + + / -0.01446121695658156 + + + + -
