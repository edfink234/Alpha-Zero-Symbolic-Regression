...
std::vector<std::vector<std::string>> WierdTrackFitter(Board& x, bool fit)
{
    ...
    track_idx = 1:
     ...
     track_idx = 2:
        ...
        depth = 26, maxsize = 174:
            Best score = 0.000566198, SNE = 1765.17
            Squared-norm error for each equation: 1535.85 229.316
...
//    puts("called SwiftHohenberg");
    ...
    Depth = 8:
     ...
     Depth = 9:
        Best score = 0.000341542, SNE = 2926.9
        Squared-norm error for each equation: 2919.87 2.79032 4.23916
        Best expression = (((((((x0 + -0.01) + sech((x1 - 1.3862943611198906))) ^ 11.13652836028018) * 2.714063572022206e-13) + (((((0.02 + x0) ^ ((0.010000 / x0) + 6.29319)) * 1e-08) + 0.013906583356672894) + 0.7500953967734456)) - (((0.9998848754538172 ^ (arcsin(tanh(x0)) / (0.7615941559557649 / (x0 ^ 4)))) * (sin(~((0.9999999999889888 * x1))) * 0.9171523356672744)) * (0.7727863849639187 * cos(asin(cos(x0)))))) - (((((x0 + (0.01 + (4.692820413780688e-06 + x0))) ^ ((0.01 ^ (6.28319 / (0.010000 + x0))) + 7.570169558264211)) * ((0.28580222883407974 ^ ((0.01 + x0) + 10.01)) * (((0.01 ^ x0) + 1.013959479790029) - sin(x1)))) + (((-4.9999166709755904e-05 + ((1.5707963267948966 + x1) + x1)) / (((-0.01 + x1) / 0.005) - (6.28319 + (535.4941684968337 + (x0 + 1.9196309107150692e+06))))) + -0.06767485271943648)) + (((((0.2658022288340797 + (0.03661899347368653 + (x0 + 0.010000))) ^ 0.9801980198019802) / ((0.03661899347368653 + (0.01 + (0.010000 + x0))) + 1.527923178056138)) ^ ((sin(x0) + (0.03661899347368653 + x0)) * (sin(x1) + (10 / (0.01 + x0))))) + (((1.5707963267948966 * (0.8414709848078965 * (x1 - 1))) / -10474.760670700261) + -0.014507687516572998))))
        Best expression (original format) = x0 -0.01 + x1 1.3862943611198906 - sech + 11.13652836028018 ^ 2.714063572022206e-13 * 0.02 x0 + 0.010000 x0 / 6.29319 + ^ 1e-08 * 0.013906583356672894 + 0.7500953967734456 + + 0.9998848754538172 x0 tanh arcsin 0.7615941559557649 x0 4 ^ / / ^ 0.9999999999889888 x1 * ~ sin 0.9171523356672744 * * 0.7727863849639187 x0 cos asin cos * * - x0 0.01 4.692820413780688e-06 x0 + + + 0.01 6.28319 0.010000 x0 + / ^ 7.570169558264211 + ^ 0.28580222883407974 0.01 x0 + 10.01 + ^ 0.01 x0 ^ 1.013959479790029 + x1 sin - * * -4.9999166709755904e-05 1.5707963267948966 x1 + x1 + + -0.01 x1 + 0.005 / 6.28319 535.4941684968337 x0 1.9196309107150692e+06 + + + - / -0.06767485271943648 + + 0.2658022288340797 0.03661899347368653 x0 0.010000 + + + 0.9801980198019802 ^ 0.03661899347368653 0.01 0.010000 x0 + + + 1.527923178056138 + / x0 sin 0.03661899347368653 x0 + + x1 sin 10 0.01 x0 + / + * ^ 1.5707963267948966 0.8414709848078965 x1 1 - * * -10474.760670700261 / -0.014507687516572998 + + + -
     ```
...
for i in range(len(consts)):
        ...
        else
        {
            SimulatedAnnealing(WierdTrackFitter /*differential equation to solve*/,
                2 /*number of equations in differential equation system*/,
                data /*data used to solve differential equation*/,
                std::vector<int>{26} /*fixed depths of generated solution*/,
                "postfix" /*expression representation*/,
                0 /*num_consts_diff: number of constants in differential equation*/,
                "LevenbergMarquardt" /*fit method if expression contains const tokens*/,
                5 /*number of fit iterations*/,
