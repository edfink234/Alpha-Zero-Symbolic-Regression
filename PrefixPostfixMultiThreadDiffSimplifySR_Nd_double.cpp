...
std::vector<std::vector<std::string>> WildfireSpreadTS(Board& x, bool fit)
{
    ...
    /*
     Best score = 1.85242e-07, SNE = 5.39835e+06
     Squared-norm error for each equation: 5.39835e+06
     Best expression = (((((9736 + (1.000000 / x13)) - ((x22 * x22) ^ cos(x6))) - ((8.851731000000001 / x6) ^ ((4.372938 + x7) - 279.200012))) + ((-3.225653 - (1075 ^ x10)) / (x5 ^ (x18 - 2)))) + ((((x24 ^ (x0 - x2)) + ((20200101.000000 ^ x15) + x20)) + (sqrt((x22 + x18)) ^ (65 - x23))) * ((((x19 + 0.006210) * 25.4) + -820.627062) + (((x23 + -330) * x22) + (acos(x21) + -18327.436844999997)))))
     Best expression (original format) = 9736 1.000000 x13 / + x22 x22 * x6 cos ^ - 8.851731000000001 x6 / 4.372938 x7 + 279.200012 - ^ - -3.225653 1075 x10 ^ - x5 x18 2 - ^ / + x24 x0 x2 - ^ 20200101.000000 x15 ^ x20 + + x22 x18 + sqrt 65 x23 - ^ + x19 0.006210 + 25.4 * -820.627062 + x23 -330 + x22 * x21 acos -18327.436844999997 + + + * +
     ```
    ...
    void WildfireSpreadTSTest(int random_seed, const char* algorithm, double time)
    {
        ...
        else
        {
            SimulatedAnnealing(WildfireSpreadTS /*differential equation to solve*/,
                ...
                1 /*number of data columns that constitute labels and not independent variables/features*/,
                false /*whether or not to include ALL of the features in all of the generated expressions*/,
                {split("0 9736 + 1.000000 x13 / + x22 x22 * x6 cos ^ - 0 8.851731000000001 + 0 x6 + / 4.372938 x7 + 0 279.200012 + - ^ - 0 0 + 0 -3.225653 + + 0 1075 + 0 x10 + ^ - 0 0 + 0 x5 + + 0 x18 + 0 2 + - ^ / + 0 x24 + x0 x2 - ^ 20200101.000000 x15 ^ 0 x20 + + + x22 x18 + sqrt 0 65 + 0 x23 + - ^ + x19 0.006210 + 0 25.4 + * 0 0 + 0 -820.627062 + + + x23 -330 + 0 x22 + * x21 acos 0 -18327.436844999997 + + + + * +")} /*seed expressions*/,
