...
#print(Benchmarks, NeuralNet, MSE)
filename = "benchmark_nn_sr_configs.txt"
for idx, benchmark, nn, mse in zip(config_idxs, Benchmarks, NeuralNet, MSE):
    #print("idx, benchmark, nn, mse =", idx, benchmark, nn, mse)
    with open(filename, "w") as f:
        f.write(f'{idx}\n')
        f.write(f'{benchmark}\n')
        #TODO: Write neural net and mse to the file, run the executable, then read them in from cpp, run
