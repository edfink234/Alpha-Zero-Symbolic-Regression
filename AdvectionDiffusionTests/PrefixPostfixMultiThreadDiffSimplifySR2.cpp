...
int main()
{
    ...
    for (int depth = 1; depth < 31; depth++)
    {
        ...
        for (int notation = 0; notation < num_notations; notation++)
        {
            ...
            //const_tokens: true, const_token: false
            Board::expression_dict.clear();
...
//g++ -Wall -std=c++20 -o PrefixPostfixMultiThreadDiffSimplifySR2 PrefixPostfixMultiThreadDiffSimplifySR2.cpp -O2 -I/opt/homebrew/opt/eigen/include/eigen3 -I/opt/homebrew/opt/eigen/include/eigen3 -I/Users/edwardfinkelstein/LBFGSpp -ffast-math -ftree-vectorize -L/opt/homebrew/Cellar/boost/1.84.0 -I/opt/homebrew/Cellar/boost/1.84.0/include -march=native

//g++ -Wall -std=c++20 -o PrefixPostfixMultiThreadDiffSimplifySR2 PrefixPostfixMultiThreadDiffSimplifySR2.cpp -g -I/opt/homebrew/opt/eigen/include/eigen3 -I/opt/homebrew/opt/eigen/include/eigen3 -I/Users/edwardfinkelstein/LBFGSpp -L/opt/homebrew/Cellar/boost/1.84.0 -I/opt/homebrew/Cellar/boost/1.84.0/include -march=native
