...
if mu_equals_nu:
    ...
    f = [\
     ...
     0.0420273224424783*r*sin(1.8419829326556*r)*sin(tanh(nu)) + (4.10254033915706 - 1.61513294036829*mu)*(0.190094777921807*mu*nu + 3.26076771793073*nu + 0.0229608421295974) + (-0.665429249609726*nu*(-mu - 17.0792539844313)*(mu - 2.54113100608342) + tanh((mu - 31.2585449073604)*sech(nu)))*(-1.08219786629523e-5*nu*(mu - 10.6683813285124) - 0.00878821578107865*sech(nu) + 0.462485362577352) + 0.978646327243359*(0.000807681538814475*nu + 0.000807681538814475*r - 0.742454862177547)*((1.00012596861858*nu + 3.07330139948275)*(0.000142078562915414*tanh(r) - 0.165074725825409) + 0.108390233596212*(sech(r) - 5.57770717367563)*sech(r) + 4.09714483852572)*sin(r)*sin(0.361068078737719*mu*nu*(nu + 5.57926688646572) + nu - 0.805264543114772*r*sin(theta) - theta + sin(mu)*tanh(nu) + sin(mu) + 9.50352882968419) + 0.0624246072101899*sin(1.80996926256808*mu + 0.801294709572602*nu + sin(sin(mu))) + sech((nu + (0.350677032904856*mu + sech(r))*(0.056164831660603*nu + 0.542281045286951) + tanh(mu) - 4.00630112426686)*(0.00200815788459499*r*tanh(r) + 9.01084137040057e-6*r + 0.0426032286065661*sech(r**2) + 0.509793809689088))
     ][2]
'''
