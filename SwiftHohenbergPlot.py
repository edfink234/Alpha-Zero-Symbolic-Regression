...
if mu_equals_nu:
    ...
    f = [\
     ...
     0.00254287910201444*mu*nu*(0.147359917162548*nu - 0.7056688466624)*sin(0.674172783666472*mu**2) - 4.48198197264545e-7*mu*r + 0.0810877362201918*mu + 0.0810877362201918*nu - 2.33445503910496e-6*r + (3.18992957488769 - 1.70303276612421*mu)*(0.0835455418421613*mu*nu + 1.61026046259918*nu + 0.0637018934893386) + (-0.00996018371756372*mu - 0.106149052714737)*sin(sin(mu) + 3.25013054480995*tanh(nu) + 1.05664485943606)*tanh(mu*nu*sin(nu))*sech(tanh(mu)) + (-1.39473286488163*nu + tanh(mu))*(0.0605705525499452*nu + 0.0864344866422965)*(-0.138684714981394*mu + nu + 2.27623683791888)*(0.416102217762023*mu - 2.08416137967387*nu + 3.64595159500108)*sin(sech(1.53383322147979*nu)) - (-0.0344134530330098*r - 5.65094431401686e-6)*sin(1.84127702597532*r) + (-7.1316131831241e-6*nu*(mu + 3.82095471240484) + 0.3921773839995)*(-0.363591856768563*nu*(-mu - 19.3148115201772)*(mu - 1.86872003480256) + tanh((mu - 47.8575885520405)*sech(nu))) + (nu + tanh(nu) - 1.18771900976201)*sech(2.28872485110542*nu) + (0.64722052140531*nu*(mu - 0.599091728898553)*sin(mu*nu) + (-0.0805416745220885*mu + sin(nu))*(mu + 145.144202022836)*(nu - 8.1638044040774)*(tanh(nu) - 1.11458738597794)*sin(mu)*tanh(nu) - (5.09762399440325*mu + sech(r))*sin(16.4391891219752*nu))*(-0.000107351613875885*mu + (0.00197470203304766 - 5.27592581844871e-8*r)*sin((mu + 0.44824598836634)*tanh(mu)) - 0.130043133965634*tanh(6.31633730154057*mu) + 0.129636363158378) - 0.727655794026031*(-0.165181035645964*nu + 0.108711492701466*(sech(r) - 5.48668357108138)*sech(r) + sech(r + 9.32015262741998) + 3.5951424643367)*sin(r)*sin(0.361068519008264*mu*nu*(nu + 5.578570675307) + nu - 0.820610053684433*r*sin(theta) - theta + sin(mu)*tanh(nu) + sin(mu) + 9.59793571321205) + (0.00950570072827367*sin(nu) + 0.011063091869858*sin(1.35035885043813*nu)*sin(1.81702982487928*mu + 0.901783587736971) + 0.137799247078617*sech(nu)*sech(0.868930448931738*r) + 0.0864890741107037)*(-mu - nu - sech(mu - 0.950837814926513) - sech(2.02149218160404*sin(nu)) + 7.39142782849348) - 0.0810877362201918*tanh(sin(nu)) + sech((nu + (0.388242524770155*mu + sech(r))*(0.0514381666389978*nu + 0.468926336584401) + tanh(mu) - 4.09593483612405)*(-2.34034501972003e-5*r*tanh(nu) + 2.46994952078469e-5*r + sech(mu*nu + 1.7429603968885) + 0.477727714968789)) + sech(nu**2*(mu + 16.8138146662097)*(0.634512039547623*nu - 2.21577822611413)) - 0.64853043786447
     ][2]
'''
