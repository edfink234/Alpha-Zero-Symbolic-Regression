...
Z = [np.sin(R)*np.sin(Theta), \
     ...
     -182.159206127457*0.28580222883408**(R + 10)*(1.02 - np.sin(Theta))*(R + 0.00999991666708333)**7.50905609893065 + 0.745258709383936*0.999884875453817**(R**4.25)*np.sqrt(1 - np.cos(R)**2)*np.sin(Theta + 6.28319) + 0.815307524508096, \
      -0.28580222883408**(R + 10.02)*(2*R + 0.0137395477321287)**(0.01**(6.28319/(R + 0.01)) + 7.57016955826421)*(0.01**R - np.sin(Theta) + 1) + 0.708762837941528*0.999884875453817**(1.3213487088109*R**4*(1.6*(np.tanh(.6*R))))*np.sqrt(1 - np.cos(R)**2)*np.sin(0.999999999988989*Theta) + 0.845330825627302][f_per_idx] \
