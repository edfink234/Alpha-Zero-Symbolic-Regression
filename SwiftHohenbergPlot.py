...
if mu_equals_nu:
    ...
    f = [\
     ...
     (0.00131164578087117 - 0.000208229049617063*mu)*(-0.0157887466417688*mu - 0.0254437435870675)*(mu*nu + nu - 0.0160529629820547*r) + (-0.00220728267096704*mu - 0.0819548879997916)*(sin(0.0333461423208871*mu + 0.738117222183146*nu + 1.75869628361995) - sin(0.569811531699208*sin(nu)))*(-0.928840023291907*mu + 0.305877668262216*nu + sin(nu)**2 + 7.18155015800352) - 0.99960666184216*(0.000100791898028392*mu*sin(mu) - 0.780466368170428)*(0.000821529937797671*mu - 0.165060037719984*nu + 4.030868845791)*sin(r - 1.65804762787468e-10)*sin(3.01909748198293*mu*nu - theta + 11.6215977433636) + (0.975144416090558*mu + sin(0.624259081811909*nu - 0.816285711728135) - 2.82851197933562)*(-0.00218720317222644*nu - 0.000517716605398788*sin(mu) - 0.0807076327837492) + 0.305646781858976,
...
=====================================
f = \left(0.00131 - 0.00021 \cdot \mu\right) \cdot \left(- 0.01579 \cdot \mu - 0.02544\right) \cdot \left(\mu \cdot \nu + \nu - 0.01605 \cdot r\right) + \left(- 0.00221 \cdot \mu - 0.08195\right) \cdot \left(\sin{\left(0.03335 \cdot \mu + 0.73812 \cdot \nu + 1.7587 \right)} - \sin{\left(0.56981 \cdot \sin{\left(\nu \right)} \right)}\right) \cdot \left(- 0.92884 \cdot \mu + 0.30588 \cdot \nu + \sin^{2}{\left(\nu \right)} + 7.18155\right) - \left(0.0001 \cdot \mu \cdot \sin{\left(\mu \right)} - 0.78016\right) \cdot \left(0.00082 \cdot \mu - 0.16506 \cdot \nu + 4.03087\right) \cdot \sin{\left(r \right)} \cdot \sin{\left(3.0191 \cdot \mu \cdot \nu - \theta + 11.6216 \right)} + \left(0.97514 \cdot \mu + \sin{\left(0.62426 \cdot \nu - 0.81629 \right)} - 2.82851\right) \cdot \left(- 0.00219 \cdot \nu - 0.00052 \cdot \sin{\left(\mu \right)} - 0.08071\right) + 0.30565
SH DAG nodes = 136
f DAG nodes = 83
mse = 88.37549409896823; Added mu=0.01, nu=0.01
mse = 69.5052529047693; Added mu=0.01, nu=5
mse = 146.5396179777127; Added mu=0.01, nu=10
mse = 18.238642368800235; Added mu=5, nu=0.01
mse = 136.1487479473163; Added mu=5, nu=5
mse = 165.5428626735836; Added mu=5, nu=10
mse = 65.24970635055426; Added mu=10, nu=0.01
mse = 169.2869780314029; Added mu=10, nu=5
mse = 166.04394998493325; Added mu=10, nu=10
Average mse = 113.88125025978232
