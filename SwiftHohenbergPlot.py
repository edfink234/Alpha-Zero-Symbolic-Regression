...
f =  [sin(r)*sin(theta), \
      ...
      -0.28580222883408**(r + 10.02)*(2*r + 0.0137395477321287)**(0.01**(6.28319/(r + 0.01)) + 7.57016955826421)*(0.01**r - sin(theta) + 1) + 0.708762837941528*0.999884875453817**(1.3213487088109*r**4*(1.6*(tanh(.6*r))))*sqrt(1 - cos(r)**2)*sin(0.999999999988989*theta) + 0.845330825627302, \
        -0.285806921654494**(r + 10.0100907998593)*(r**1.00009081398177 + r**((r + 1)**0.0100001666741671))**(0.015**(6.28319/(r + 2)) + 7.59399521303526)*(- sin(theta + cos(theta) + 6.28319) + sin(log(r))) + 0.612417858855597*0.999884875453817**(1.4426686039141*(r + 0.01)**4*(1.6*(tanh(.6*r))))*sqrt(1 - cos(r)**2)*sin(theta) + 0.879032771381193][f_per_idx] \
...
Z = [np.sin(R)*np.sin(Theta), \
     ...
     -182.159206127457*0.28580222883408**(R + 10)*(1.02 - np.sin(Theta))*(R + 0.00999991666708333)**7.50905609893065 + 0.745258709383936*0.999884875453817**(R**4.25)*np.sqrt(1 - np.cos(R)**2)*np.sin(Theta + 6.28319) + 0.815307524508096, \
      ...
      -0.285806921654494**(R + 10.0100907998593)*(R**1.00009081398177 + R**((R + 1)**0.0100001666741671))**(0.015**(6.28319/(R + 2)) + 7.59399521303526)*(- np.sin(Theta + np.cos(Theta) + 6.28319) + np.sin(np.log(R))) + 0.612417858855597*0.999884875453817**(1.4426686039141*(R + 0.01)**4*(1.6*(np.tanh(.6*R))))*np.sqrt(1 - np.cos(R)**2)*np.sin(Theta) + 0.879032771381193][f_per_idx] \
