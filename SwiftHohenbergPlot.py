...
if mu_equals_nu:
    ...
    f = [\
     ...
     -(3.42769855725082e-6 - 0.0425155973585892*r)*sin(1.83888467199984*r)*sin(tanh(nu)) + (15.7532142829179 - 5.96598463805712*mu)*(0.19587110855383*mu*nu + 1.89002827768417*nu + 0.00212348043022316) + 0.978498812756865*(0.000822076798295092*r - 0.736567876150446)*((1.00112958309879*nu + 3.0806055823144)*(0.000171062712377584*sin(r) - 0.165093193899329) + 0.109735079473066*(sech(r) - 5.58470527071312)*sech(r) + 4.09621585331804)*sin(r)*sin(0.361044154101279*mu*nu*(nu + 5.57945027236868) + nu - 0.803239861909382*r*sin(theta) - theta + sin(mu)*tanh(nu) + sin(mu) + 9.50377147827361) + (-2.31793160448949*nu*(-mu - 9.61745637064449)*(mu - 2.64114617943776) + tanh((mu - 31.2153346793704)*sech(nu)))*(-8.37074345255136e-6*nu*(mu - 10.861949923122) - 0.00444787037745223*sech(nu) + 0.50478336807783) + 0.0828178417288395*sin(r*tanh(nu**2)*tanh(tanh(0.573229709287524*r))) + sech((0.992581181098554*nu + (0.339391346372304*mu + sech(r))*(0.0584585842806291*nu + 0.534912761481889) - 3.0897621796955)*(0.00721200030941675*r*sin(r) + 1.03545626927677e-5*r + 0.050713367871622*sech(r**2) + 0.508162895739478))
     ][2]
'''
