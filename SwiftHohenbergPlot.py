...
if mu_equals_nu:
    ...
    f = [\
     ...
     -(2.99749595391081e-6 - 0.0423106454890323*r)*sin(1.84189173100415*r)*sin(tanh(nu)) + (4.11598232799081 - 1.62039533081727*mu)*(0.18974519269261*mu*nu + 3.24815853704791*nu + 0.0210844511121434) + 0.978646327243359*(0.000807681538814475*r - 0.736772352201387)*((1.00077565116827*nu + 3.07886783314792)*(0.000167927032367178*sin(r) - 0.165074725825409) + 0.109194650551357*(sech(r) - 5.58282147379127)*sech(r) + 4.09662684233472)*sin(r)*sin(0.361068078737719*mu*nu*(nu + 5.5792674062136) + nu - 0.80360322261728*r*sin(theta) - theta + sin(mu)*tanh(nu) + sin(mu) + 9.50365560003753) + (-0.66543642918674*nu*(-mu - 17.0761809770415)*(mu - 2.54109669660436) + tanh((mu - 30.7402734385844)*sech(nu)))*(-7.00853996511713e-6*nu*(mu - 12.3482260156268) - 0.00982863027828837*sech(nu) + 0.462485174941213) + 0.0774761958094058*sin(r*tanh(nu**2)*tanh(tanh(0.60821947044991*r))) + sech((nu + (0.358928084804609*mu + sech(r))*(0.0589364092396972*nu + 0.536062451489167) - 3.10944975168564)*(0.00297154792929412*r*sin(r) + 9.98387891357844e-6*r + 0.0467018474010314*sech(r**2) + 0.508854274637433))
     ][2]
'''
