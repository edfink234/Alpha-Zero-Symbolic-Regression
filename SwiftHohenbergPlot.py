...
if mu_equals_nu:
    ...
    f = [\
     ...
     - 84.0357720038456,
     (sin((((9.71221746517301 - (0.009986312696023117 + nu)) * cos((2.489795678782283 + mu))) + (((0.002424273003875368 + theta) - 16.22428821569935) - (6.2837758300132975 * (4 + nu))))) * ((tanh(((mu * 9.965061806672827) + -3.7909453384282488)) * (((1.8315212884296368 * mu) * 1.1011191958232304e-11) - sin(r))) * ((((mu * 0.01376994854395285) * cos(nu)) + 3.69245056741647) - (0.1425912833329323 * (0.025375554582084223 + (0.00028194332410969025 + nu))))))
     ][1]
