...
if mu_equals_nu:
    ...
    f = [\
     ...
     -0.99960666184216*(0.000100791898028392*mu*sin(mu) - 0.780466368170428)*(0.000821529937797671*mu - 0.165060037719984*nu + 4.03086884584505)*sin(r - 1.65804762787468e-10)*sin(3.01909748198293*mu*nu - theta + 11.6215977433636) + (-sin(0.495407330220973*sin(nu) + 0.099839634450563) + sin(0.0466695570497925*mu + 0.730551627004849*nu + 1.8187525946419))*(0.0655588488832756*mu - 0.014281820068966*nu - 0.0805268286877543*sin(nu)**2 - 0.588408610448793) + (1.01658443860494*mu + sin(0.751159281078818*nu - 1.2703372777299) + 0.225904842410586)*(-0.00043359194414595*nu - 9.74118281773854e-8*r - 0.0810196059138394) + 0.507792266376046,
...
=====================================
f = \left(- 0.00043 \cdot \nu - 0.08102\right) \cdot \left(1.01658 \cdot \mu + \sin{\left(0.75116 \cdot \nu - 1.27034 \right)} + 0.2259\right) + \left(- 0.0001 \cdot \mu \cdot \sin{\left(\mu \right)} + 0.78016\right) \cdot \left(0.00082 \cdot \mu - 0.16506 \cdot \nu + 4.03087\right) \cdot \sin{\left(r \right)} \cdot \sin{\left(3.0191 \cdot \mu \cdot \nu - \theta + 11.6216 \right)} + \left(- \sin{\left(0.49541 \cdot \sin{\left(\nu \right)} + 0.09984 \right)} + \sin{\left(0.04667 \cdot \mu + 0.73055 \cdot \nu + 1.81875 \right)}\right) \cdot \left(0.06556 \cdot \mu - 0.01428 \cdot \nu - 0.08053 \cdot \sin^{2}{\left(\nu \right)} - 0.58841\right) + 0.50779
SH DAG nodes = 126
f DAG nodes = 70
mse = 88.96893898666913; Added mu=0.01, nu=0.01
mse = 68.958246475421; Added mu=0.01, nu=5
mse = 147.16380702289163; Added mu=0.01, nu=10
mse = 18.417964407339788; Added mu=5, nu=0.01
mse = 136.23375580209998; Added mu=5, nu=5
mse = 165.9052028927753; Added mu=5, nu=10
mse = 65.60445328273227; Added mu=10, nu=0.01
mse = 170.05378168137753; Added mu=10, nu=5
mse = 167.97089760549278; Added mu=10, nu=10
Average mse = 114.36411646186662
