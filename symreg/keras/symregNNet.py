...
#            self.clf_value = make_pipeline(StandardScaler(), GaussianProcessRegressor(kernel = RBF() + WhiteKernel(), random_state=0))
#            self.clf_value = make_pipeline(StandardScaler(), GaussianProcessRegressor(kernel = ExpSineSquared(length_scale=1, periodicity=1) + WhiteKernel(), random_state=0))
...
#                self.clf_policy.append(make_pipeline(StandardScaler(), GaussianProcessRegressor(kernel = RBF() + WhiteKernel(), random_state=0)))
#                self.clf_policy.append(make_pipeline(StandardScaler(), GaussianProcessRegressor(kernel = ExpSineSquared(length_scale=1, periodicity=1) + WhiteKernel(), random_state=0)))
