...
if GENERIC:
    ...
    f =  [-0.998846776839887*0.999950000416665**(r**4)*sin(r)*sin(theta) + 2.71782596428238e-13*10.36319**(r + 0.01) + 0.00164034101997398*theta - (r/(r + 2))**(r + 6.35319) + 0.6448561035289, sin(r)*sin(theta)+0.604, sin(r)*sin(theta), 0.998846776839887*0.999950000416665**(r**4)*sin(r)*sin(theta) + 0.604, ((((((1 + r) ** 11) * 2.714063472005533e-13) + 0.708606338968803) - (((0.9999500004166652 ** (r ** 4)) * (sin(theta) * 0.9999500004166652)) * (0.9989466681771987 * (sin(r) * 0.9999500004166652)))) - ((((5.049999999999999 + (theta + 4)) / -11.89772233983162) * 0.01865962687364277) + (((r / (r + 2)) ** ((r + 0.010000) + 6.343189999999999)) + 0.08377453094903319)))][-1] \
