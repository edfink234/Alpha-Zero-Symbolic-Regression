...
if GENERIC:
    ...
    f =  [(((((10.283190000000001 ** (0.010000 + r)) * 2.714063472005533e-13) + 0.7048172460634555) - ((0.999329299739067 * sin((0.010000 + theta))) * (0.9989466681769272 * sin(r)))) - ((((6.28319 + (1 + theta)) / -10.849071529076452) * 0.0198) + (((r / (r + 2)) ** ((r + 0.010000) + 6.30319)) + 0.09367415161541374))), sin(r)*sin(theta)+0.604, sin(r)*sin(theta)][0] \
