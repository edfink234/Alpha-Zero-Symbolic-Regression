...
#              + (5.52136873685152e-15*6.45127057152239**(r + 0.0565869958743546) + 5.52136873685152e-15*cos(theta - 1.14278632914743))*(4.69282041378069e-6*exp(theta) + 0.478323918013976)**(-11.2069358951144 - theta/1.96953999447147**theta)
...
#              + (8.133634781186*theta + 210.8664358206)/(sech(1.23159415646033/r) + 22208.9094631345)
              - ((0.00474887729937578**theta + 1.5707963267949)**(sech(theta) - 18.3837681892581) + 0.285811651486423)**(0.00950293076446861**theta*theta**2 + r + sech(r + 0.0561717295263584) + 10.0547134992516)*(r + (r**0.999950000416665 - 0.00364405505237706)**((0.376065617272839**r + r)**0.00999966667999946) + 0.0106243230277353)**(-r**2/(exp(r) + 1358.42254658947) + (0.000469282041378069*r + 0.0160184860388267)**((sin(r) + 6.78974430415452)/(r - 0.00781876960101768)) + 7.58897670822754)*(-sin(theta + cos(theta - 0.0144023112886078) + 0.105413950813453) + sin(log(r + 0.390458429297535)) + ((-tanh(0.62*r)+1.01)*(pi/2))**(0.061275433230159*r + 0.00061275433230159))*(.5*(1-tanh(2e-1*(r-10)))) # MARK: FIXME
#              - (tanh(2*r)**(26.0630000590122*r**6.29029115986841) + 95.2404187164865)/(r + (0.0053984397980632*r + 5.3984397980632e-5)*log(tanh(r)) - 10335.0958606709)
              + (0.00273233753019377**(6.19641677671904 - sin(theta + 0.089280925720443)) + 2.79499001433555e-13 + (3.81443804056055e-19*exp(theta) + 6.12323399573677e-17)/(2.19270786451049 - 6.28221254344588*r))*(0.999329299739067*r + cos(sin(theta + 6.27413177595865) - 0.642895014613991) + 0.453212918064574 + 0.0642488695439412/1.99535617369085**theta)**(sin(sqrt(r + 9.07998593378172e-5)) + 11.4130415650481 + 4.69282041378069e-6/sech(theta) + 0.00010001/(1.01005016708417 - cos(theta)))*(.5*(1-tanh(2e-1*(r-10)))) # MARK: FIXME
#              + (0.0198370015775754**(tanh(theta) + 7.93024265961469) + 4.85851653532341e-19*r*theta**2/(5.73576501270149 - 2*r) + 2.89036725439893e-13)*(1.87368352123689*r + 10.5926268755992*theta + (theta + 6.6244829732113)*exp(r) + 2.57539899861567)**(cos(tanh(sin(theta))) + sech(theta + 0.114076364228401))
              - ((sin(theta) + 1.81465628877088)*sin(r + 0.0428431433987448) - log(r) + tanh(sin(r)) + 11.8460597445485)**(0.74666154308685*r - 9.55656216208119)*(.5*(1-tanh(2e-1*(r-10)))) # MARK: FIXME
