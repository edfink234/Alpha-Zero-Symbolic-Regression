...
if GENERIC:
    ...
    f =  [(((((10.01 ** (0.010000 + r)) * 2.714063472005533e-13) + 0.7047172460634555) - ((0.999329299739067 * sin((0.010000 + theta))) * (0.9989466681769271 * sin(r)))) - ((((6 + (1 + theta)) / -10.839071529076453) * 0.020122271709039314) + (((r / (r + 2)) ** ((r + 0.010000) + 6.29319)) + 0.09268112623466472))), sin(r)*sin(theta)+0.604, sin(r)*sin(theta)][0] \
