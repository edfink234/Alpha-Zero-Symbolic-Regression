...
if GENERIC:
    ...
    f =  [-0.998846776839887*0.999950000416665**(r**4)*sin(r)*sin(theta) + 2.71782596428238e-13*10.36319**(r + 0.01) + 0.00164034101997398*theta - (r/(r + 2))**(r + 6.35319) + 0.6448561035289, sin(r)*sin(theta)+0.604, sin(r)*sin(theta), 0.998846776839887*0.999950000416665**(r**4)*sin(r)*sin(theta) + 0.604, 0.88898139159952*0.999884875453817**(r**4.03)*sqrt(1 - cos(r)**2)*sin(theta) + 0.760176150613572,\
        ...
        (((((((0.02 + (r + 0.010000)) + sech(theta+(pi/3))) ** 11.13) * 2.714063572022206e-13) + (((((0.010000 + r) ** 6.28319) * 1e-08) + (-0.00999966667999946 + ((theta+(pi/3)) * 0.001))) + 0.7456387750685652)) - (((0.9998848754538172 ** (asin(tanh(r)) / (1 / (r ** 4)))) * (sin(-((6.283190 + (theta+(pi/3))))) * 0.980049833749168)) * (0.8027863870888163 * cos(asin(cos(r)))))) - (((((r + r) ** 7.38905609893065) * ((0.28580222883407974 ** (r + 10)) * (1.01 - sin((0.010000 + (theta+(pi/3))))))) + -0.055170326573189814) + ((((0.005 + r) ** 0.9999500004166652) / ((0.01 + r) + 1.5079230113819708)) ** ((sin(r) + r) * (sin((6.283190 + (theta+(pi/3)))) + (10.01 / r))))))][-1] \
