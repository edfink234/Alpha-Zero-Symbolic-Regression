...
int main()
{
    ...
    test_expr = {"16.33924080923353", "x0", "*", "30.468190779408285", "+", "x0", "4", "*", "4.138727622547689", "x0", "*", "x0", "0.012707812385279542", "-", "*", "0.6549526522886", "x0", "*", "4", "x0", "*", "sin", "tanh", "*", "-0.4238983078352339", "x0", "asin", "cos", "*", "+", "6.381390158771741", "+", "*", "x0", "-17.14466672126029", "*", "x0", "tanh", "asin", "asin", "*", "+", "-6.193808021369177", "x0", "asin", "x0", "+", "sqrt", "*", "+", "3.460986923224668", "+", "*", "x0", "x0", "0.7059231254841601", "-", "+", "0.31795044001967315", "x0", "sqrt", "*", "0.13909553009610104", "10.6415385122204", "x0", "*", "sin", "*", "-", "-0.7495753978722329", "+", "*", "+", "x0", "-17.10803513548826", "*", "sech", "asin", "tanh", "-", "*", "1.4547523430453513", "51.0727674445071", "x0", "*", "sin", "*", "-", "1.3485364816657164", "51.4695471152235", "x0", "*", "sin", "*", "+", "-0.5529713081873325", "x0", "x0", "acos", "46.6177357352168", "-", "*", "sin", "*", "-", "21.781675812494058", "7.16097575179141", "x0", "*", "-0.449633886353245", "+", "cos", "sin", "*", "-", "0.46792260811732783", "39.2824846709371", "x0", "*", "cos", "*", "+", "0.1920450163991527", "-63.3624466252343", "x0", "*", "cos", "*", "+", "-38.86410106871416", "x0", "arccos", "0.6604843080310615", "-", "sech", "acos", "*", "-", "x0", "-0.7107421586596806", "+", "0.14140769992208382", "0.4042229057324642", "x0", "2", "-", "85.89138216668816", "x0", "-16.203823177756178", "*", "+", "*", "+", "cos", "arcsin", "*", "*", "+"};
    printf("before: ");print_container(test_expr);printf(", test_expr.size() = %lu\n", test_expr.size());
    simplifyRPN(test_expr);
    printf("after: ");print_container(test_expr);printf(", test_expr.size() = %lu\n", test_expr.size());
    puts("");
