...
int main()
{
    ...
    test_expr = {"30.472204645646173", "x0", "17.133742761563433", "*", "+", "4", "x0", "*", "6.4061897227356", "x0", "*", "x0", "-0.056903391450683294", "+", "*", "0.4670391354423534", "x0", "*", "4", "x0", "*", "sin", "tanh", "*", "0.2536909544712677", "x0", "acos", "sin", "*", "-", "4.135127832445621", "+", "*", "-16.211831635976864", "x0", "*", "x0", "sech", "acos", "asin", "*", "+", "-5.621714295502056", "x0", "asin", "x0", "+", "sqrt", "*", "+", "-3.1864562568596844", "-", "*", "x0", "2.662257608487987", "*", "1", "-", "x0", "sqrt", "-0.12898265431332132", "x0", "+", "*", "-0.12888067967297026", "10.6415385122204", "x0", "*", "sin", "*", "-", "0.5063019336516834", "+", "*", "-", "x0", "-17.150069520115206", "*", "sech", "asin", "tanh", "-", "*", "-1.4456077988415068", "51.0727674445071", "x0", "*", "sin", "*", "+", "1.3467239868528782", "51.4695471152235", "x0", "*", "sin", "*", "+", "-0.5340747782109373", "x0", "x0", "acos", "46.6177357352168", "-", "*", "sin", "*", "-", "-24.481617286963157", "7.16097575179141", "x0", "*", "-0.44930469285092417", "+", "cos", "sin", "*", "+", "0.45930342833798476", "-39.25974068774718", "x0", "*", "cos", "*", "+", "0.1925065041922314", "-63.3624466252343", "x0", "*", "cos", "*", "+", "37.480727200062674", "0.6607975282775022", "x0", "arccos", "-", "cos", "arccos", "*", "+", "0.6973183953529231", "x0", "-", "-0.21328377333647777", "7.570088972965155", "x0", "2", "-", "85.89138216668816", "x0", "16.33421346576555", "*", "-", "*", "-", "sin", "*", "*", "+", "0.028735816762602204", "0.007175807609932588", "x0", "*", "-", "5.030375868616961", "4", "4", "*", "*", "x0", "3.014078014652437", "x0", "-56", "*", "*", "sin", "+", "*", "tanh", "*", "+"};
    printf("before: ");print_container(test_expr);printf(", test_expr.size() = %lu\n", test_expr.size());
    simplifyRPN(test_expr);
    printf("after: ");print_container(test_expr);printf(", test_expr.size() = %lu\n", test_expr.size());
    puts("");
